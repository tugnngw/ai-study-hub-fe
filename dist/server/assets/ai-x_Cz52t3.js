import { s as ragApi } from "./realApi-D5l_6Aet.js";
import { t as Route } from "./ai-DVC6VTFV.js";
...
import { N as useUploadDocument, a as useDocument, b as useQuizByDocument, d as useFolder, f as useFolders, h as useGenerateSummary, k as useSummary, m as useGenerateQuiz, p as useGenerateFlashcards, s as useDocumentsByFolder, u as useFlashcardsByDocument, x as useRagChat, y as useProcessRag } from "./queries-nabbXKnl.js";
...
import { t as DocumentActionsMenu } from "./document-actions-menu-Cr2ZtY9T.js";
...
function AIChat({ folderId, docId }) {
	...
	const pollStatus = useCallback((id) => {
		return new Promise((resolve) => {
			...
			const check = async () => {
				...
				pollingTimerRef.current = setTimeout(check, 3e3);
			};
			check();
		});
	}, [qc]);
	const processDocument = useCallback(async (id) => {
	...
	useEffect(() => {
		if (docId) processDocument(docId);
		return () => {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					activeTab === "content" && /* @__PURE__ */ jsx("div", {
						...
						children: docId && (doc.data?.status === "READY" || doc.data?.status === "COMPLETED") ? /* @__PURE__ */ jsx(DocumentViewer, { document: doc.data }) : doc.data?.status === "PROCESSING" ? /* @__PURE__ */ jsx("div", {
						...
						children: [messages.length === 0 ? /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: docId ? "Hỏi AI về nội dung của tài liệu đang chọn." : folderId ? "Hỏi AI về tất cả tài liệu trong thư mục này." : "Chọn một thư mục để bắt đầu trò chuyện."
								})
							]
