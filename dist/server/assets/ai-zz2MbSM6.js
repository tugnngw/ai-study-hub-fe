import { o as quizApi, r as documentApi } from "./realApi-BCKVeZFR.js";
import { t as Route } from "./ai-BqHMPBZa.js";
import { C as useProcessRag, D as useRagSession, E as useRagChat, O as useRagSessionDetail, T as useQuota, U as useUploadDocument, _ as useGenerateSummary, a as useDeleteRagSession, c as useDocumentsByFolder, d as useFlashcardsByDocument, f as useFolder, g as useGenerateQuiz, h as useGenerateFlashcards, k as useRagStatus, m as useFolders, o as useDocument, w as useQuizByDocument, z as useSummary } from "./queries-BOxd9l6F.js";
import { n as formatBytes, t as cn } from "./utils-CZKD4yH6.js";
...
import { a as DropdownMenuSeparator, i as DropdownMenuLabel, n as DropdownMenuContent, o as DropdownMenuTrigger, r as DropdownMenuItem, t as DropdownMenu } from "./dropdown-menu-Dd2HU7wv.js";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, t as Dialog } from "./dialog-BwVCGmke.js";
...
import { n as aiUnavailableReason, r as isAIAvailable, t as DocumentViewer } from "./DocumentViewer-BRNxCtPs.js";
import { t as Progress } from "./progress-Dvb72S3o.js";
import { t as DocumentStatusBadge } from "./document-status-badge-BNZIDwVk.js";
import { useCallback, useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { AlertTriangle, ArrowRight, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, FileText, FolderClosed, FolderX, Infinity as Infinity$1, Info, Loader2, MessageSquare, Plus, RefreshCw, RotateCcw, Send, Shuffle, Sparkles, Trash2, Upload, X, XCircle } from "lucide-react";
		...
		return /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					className: isExhausted ? "text-red-600 font-medium" : isLow ? "text-amber-600 font-medium" : "text-muted-foreground",
					children: isExhausted ? "Hết lượt" : `Còn ${remaining}/${limit} lượt`
				})]
	...
	return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Info, { className: "h-4 w-4 text-muted-foreground" }),
				/* @__PURE__ */ jsx("span", {
					className: "text-sm font-medium",
...
function AISummary({ docId, onGenerate, isGenerating, summary }) {
	...
	const isLow = limit > 0 && remaining <= Math.floor(limit * .2) && remaining > 0;
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("button", {
					...
					children: isGenerating ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Generating..."] }) : isExhausted ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), "Hết lượt"] }) : summary ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(RefreshCw, { className: "h-4 w-4" }), "Regenerate Summary"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), "Generate Summary"] })
				}),
				isLow && /* @__PURE__ */ jsxs("p", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "absolute inset-0 rounded-2xl shadow-xl flex flex-col items-center justify-center p-10 text-center",
						style: {
...
function FlashcardTab({ docs, docId }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col flex-1 min-h-0",
		children: [/* @__PURE__ */ jsx("div", {
			className: "flex-1 overflow-y-auto px-4 pt-4 pb-2 lg:px-6 lg:pt-6",
			children: /* @__PURE__ */ jsx("div", {
			...
			className: "px-4 pb-2 pt-2 border-t border-border space-y-2",
			children: [
				/* @__PURE__ */ jsx(QuotaDisplay, {}),
				/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-3",
					children: [
						...
						isExhausted && /* @__PURE__ */ jsxs("span", {
							className: "text-xs text-red-600 flex items-center gap-1 shrink-0",
							children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-3 w-3" }), "Hết lượt"]
						}),
						/* @__PURE__ */ jsx(Button, {
							...
							children: generateFlashcards.isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Generating..."] }) : isExhausted ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), "Hết lượt"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), "Generate Flashcards"] })
						})
					]
				}),
				isLow && /* @__PURE__ */ jsxs("p", {
...
function QuizViewer({ quizzes, isLoading }) {
	...
	const selectAnswer = useCallback(async (opt) => {
		if (!current || results.has(current.q.id)) return;
	...
	if (finished) {
		...
		return /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("span", {
							...
							children: ["Correct: ", correctCount]
						}),
						/* @__PURE__ */ jsxs("span", {
							className: "text-red-600 font-medium",
							children: ["Wrong: ", wrongCount]
						}),
						/* @__PURE__ */ jsxs("span", {
				...
				allQuestions.length > 0 && /* @__PURE__ */ jsx("div", {
					className: "w-full max-w-2xl space-y-3 max-h-[40vh] overflow-y-auto",
					children: allQuestions.map(({ q }, i) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								}), r ? r.correct ? /* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1 text-[11px] text-green-600 bg-green-500/10 px-2 py-0.5 rounded-full shrink-0",
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-3 w-3" }), " Correct"]
								}) : /* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1 text-[11px] text-red-600 bg-red-500/10 px-2 py-0.5 rounded-full shrink-0",
									children: [/* @__PURE__ */ jsx(XCircle, { className: "h-3 w-3" }), " Incorrect"]
								}) : /* @__PURE__ */ jsx("span", {
									className: "text-[11px] text-muted-foreground shrink-0",
									children: "Không trả lời"
								})]
							}), /* @__PURE__ */ jsx("div", {
								...
								children: opts.map((opt) => {
									...
									return /* @__PURE__ */ jsx("div", {
										className: cn("text-xs px-2.5 py-1.5 rounded-md border", isCorrect && "border-green-500/50 bg-green-500/10 text-green-700", !isCorrect && isSelected && "border-red-500/50 bg-red-500/10 text-red-700", !isCorrect && !isSelected && "border-border text-muted-foreground"),
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "w-full max-w-2xl p-8 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-xl text-white text-center",
				children: [/* @__PURE__ */ jsxs("p", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: options.map((opt) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						className: cn("w-full flex items-center gap-3 p-4 rounded-xl border-2 text-left transition-all", locked ? cn(isCorrect && "border-green-500 bg-green-500/10", isWrongPick && "border-red-500 bg-red-500/10", !isCorrect && !isWrongPick && "border-border bg-card opacity-60") : cn(isSelected && "border-indigo-400 bg-indigo-50 dark:bg-indigo-950", !isSelected && "border-border bg-card hover:border-indigo-300 hover:bg-accent")),
						children: [
							/* @__PURE__ */ jsx("span", {
								className: "text-sm flex-1",
								children: opt.content
							}),
							locked && isCorrect && /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-green-600 shrink-0" }),
							locked && isWrongPick && /* @__PURE__ */ jsx(XCircle, { className: "h-4 w-4 text-red-600 shrink-0" })
						]
					}, opt.label);
				})
			}),
			isAnswered ? /* @__PURE__ */ jsx(Button, {
				onClick: onNext,
				variant: "default",
				className: "gap-2 mt-1",
				children: currentIdx < allQuestions.length - 1 ? /* @__PURE__ */ jsxs(Fragment, { children: ["Next Question ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })] }) : /* @__PURE__ */ jsxs(Fragment, { children: ["Xem kết quả ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })] })
			}) : /* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Button, {
							...
							className: `gap-2 flex-1 ${isExhausted ? "opacity-50" : ""}`,
							children: generateQuiz.isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Generating..."] }) : isExhausted ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), "Hết lượt"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), "Generate Quiz"] })
						})
					]
				}),
				isLow && /* @__PURE__ */ jsxs("p", {
...
function AIChat({ folderId, docId }) {
	...
	const saveWidths = () => {
		try {
			localStorage.setItem("ai-left", String(leftW));
			localStorage.setItem("ai-right", String(rightW));
		} catch {}
	};
	...
	if (folder.isError) return /* @__PURE__ */ jsxs("div", {
		ref: containerRef,
	...
	return /* @__PURE__ */ jsxs("div", {
		ref: containerRef,
		className: "flex flex-col lg:flex-row h-full gap-1.5 p-3",
		children: [
			/* @__PURE__ */ jsxs("aside", {
				className: "hidden lg:flex flex-col bg-card/50 backdrop-blur-md border border-border/50 rounded-2xl p-4 overflow-hidden shadow-soft shrink-0",
				style: { width: leftW },
				children: [
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							docs.map((d) => {
								...
								return /* @__PURE__ */ jsxs("div", {
									className: cn("group flex items-center gap-2 rounded-lg pl-2 pr-1 py-2 transition-colors", active ? "bg-primary/5 border-l-2 border-primary" : "hover:bg-accent border-l-2 border-transparent"),
									children: [/* @__PURE__ */ jsxs(Link, {
										to: "/ai",
										search: {
											f: folderId,
			...
			/* @__PURE__ */ jsxs("section", {
				className: "flex flex-col bg-card flex-1 min-w-0 min-h-0 rounded-xl border border-border/60 shadow-sm",
				children: [
					/* @__PURE__ */ jsx("div", {
					...
					activeTab === "content" && /* @__PURE__ */ jsx("div", {
						...
						children: docId && doc.data ? /* @__PURE__ */ jsx(DocumentViewer, {
							document: doc.data,
							className: "flex-1 w-full h-full"
						}) : docId && doc.isError ? /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col items-center justify-center h-full gap-3 p-8 text-center",
							children: [
								/* @__PURE__ */ jsx(AlertTriangle, { className: "h-12 w-12 text-muted-foreground/50" }),
								/* @__PURE__ */ jsx("h3", {
									className: "text-lg font-semibold",
									children: "Tài liệu không tồn tại hoặc đã bị xoá"
								}),
								/* @__PURE__ */ jsx("p", {
									className: "text-sm text-muted-foreground max-w-sm",
									children: "Tài liệu này có thể đã bị xoá hoặc bạn không có quyền truy cập."
								})
							]
					...
					" ",
					activeTab === "summary" && /* @__PURE__ */ jsx("div", {
						className: "flex-1 min-h-0 overflow-hidden flex flex-col",
						children: !aiAllowed ? /* @__PURE__ */ jsx(AiBlockedOverlay, { reason: aiBlockReason }) : aiStatus === "NOT_STARTED" ? /* @__PURE__ */ jsxs("div", {
					...
					activeTab === "flashcards" && /* @__PURE__ */ jsx("div", {
						className: "flex-1 min-h-0 overflow-hidden flex flex-col",
						children: !aiAllowed ? /* @__PURE__ */ jsx(AiBlockedOverlay, { reason: aiBlockReason }) : aiStatus === "NOT_STARTED" ? /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col items-center justify-center h-full gap-4 p-8",
							children: [
					...
					activeTab === "quizzes" && /* @__PURE__ */ jsx("div", {
						className: "flex-1 min-h-0 overflow-hidden flex flex-col",
						children: !aiAllowed ? /* @__PURE__ */ jsx(AiBlockedOverlay, { reason: aiBlockReason }) : aiStatus === "NOT_STARTED" ? /* @__PURE__ */ jsxs("div", {
							className: "flex flex-col items-center justify-center h-full gap-4 p-8",
							children: [
			...
			/* @__PURE__ */ jsxs("aside", {
				className: "flex flex-col bg-card overflow-hidden shrink-0 rounded-xl border border-border/60 shadow-sm",
				style: { width: rightW },
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
							...
							className: "text-xs text-muted-foreground truncate shrink-0 ml-auto max-w-[160px] flex items-center gap-1.5",
							title: doc.data.title,
							children: [
								/* @__PURE__ */ jsx(FileText, { className: "h-3 w-3 shrink-0 -mt-0.5" }),
								/* @__PURE__ */ jsx("span", {
									className: "truncate",
									children: doc.data.title
								}),
								/* @__PURE__ */ jsx(DocumentStatusBadge, {
					...
					!aiAllowed ? /* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsx(Input, {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								className: `text-xs ${input.length > 2e3 ? "text-destructive" : "text-muted-foreground"}`,
								children: [input.length, " / 2000"]
							}), /* @__PURE__ */ jsx(Button, {
								type: "submit",
								size: "icon",
...
function AiBlockedOverlay({ reason }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-12 w-12 text-amber-500" }), /* @__PURE__ */ jsx("p", {
			className: "text-sm text-muted-foreground max-w-sm",
			children: reason ?? "Tính năng AI không khả dụng cho tài liệu này."
		})]
	});
}
					...
					children: [
						...
						!multiple && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Label, { children: "Tiêu đề" }), /* @__PURE__ */ jsxs("span", {
									className: `text-xs ml-auto ${title.length > 255 ? "text-destructive" : "text-muted-foreground"}`,
									children: [title.length, " / 255"]
								})]
							}), /* @__PURE__ */ jsx(Input, {
								value: title,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center",
								children: [/* @__PURE__ */ jsx(Label, { children: "Mô tả (tuỳ chọn)" }), /* @__PURE__ */ jsxs("span", {
									className: `text-xs ml-auto ${description.length > 500 ? "text-destructive" : "text-muted-foreground"}`,
