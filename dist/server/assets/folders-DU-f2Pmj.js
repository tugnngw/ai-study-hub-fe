import { t as Route } from "./folders-B2zDCZA8.js";
import { H as useUpdateFolder, I as useSubjects, L as useSubjectsBySemester, N as useSemesters, i as useDeleteFolder, m as useFolders, t as useCreateFolder } from "./queries-BOxd9l6F.js";
import { n as formatBytes, t as cn } from "./utils-CZKD4yH6.js";
import { n as buttonVariants, t as Button } from "./button-C90jjaif.js";
import { t as Input } from "./input-Cek7xrlr.js";
import { t as Skeleton } from "./skeleton-_R9c2vuT.js";
import { a as DropdownMenuSeparator, n as DropdownMenuContent, o as DropdownMenuTrigger, r as DropdownMenuItem, t as DropdownMenu } from "./dropdown-menu-Dd2HU7wv.js";
...
import { t as ShareEntityDialog } from "./share-entity-dialog-Bu9egycG.js";
...
function FoldersPage() {
	...
	const folderCount = (f) => f.documentCount ?? 0;
...
function FolderFormDialog({ open, onOpenChange, folder, initialSubjectId, returnAfterCreate }) {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-1.5",
							children: [/* @__PURE__ */ jsx(FolderKanban, { className: "h-4 w-4 text-muted-foreground" }), /* @__PURE__ */ jsx(Label, { children: "Folder name" })]
						}), /* @__PURE__ */ jsx(Input, {
							value: name,
...
function DeleteFolderDialog({ folder, onClose }) {
	...
	return /* @__PURE__ */ jsx(AlertDialog, {
		...
		children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [/* @__PURE__ */ jsxs(AlertDialogHeader, { children: [/* @__PURE__ */ jsx(AlertDialogTitle, { children: "Delete folder?" }), /* @__PURE__ */ jsxs(AlertDialogDescription, { children: [
			...
			children: del.isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 mr-1 animate-spin" }), "Deleting..."] }) : "Delete"
		})] })] })
	});
}
//#endregion
