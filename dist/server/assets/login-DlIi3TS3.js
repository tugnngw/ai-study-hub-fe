import { n as authApi } from "./realApi-BCKVeZFR.js";
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Label, {
								htmlFor: "username",
								children: "Tên đăng nhập hoặc email"
							}), /* @__PURE__ */ jsxs("span", {
								className: `text-xs ml-auto ${form.username.length > 255 ? "text-destructive" : "text-muted-foreground"}`,
								children: [form.username.length, " / 255"]
							})]
						}),
						/* @__PURE__ */ jsx(Input, {
							id: "username",
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("span", {
									className: `text-xs ${form.password.length > 128 ? "text-destructive" : "text-muted-foreground"}`,
									children: [form.password.length, " / 128"]
								}),
								/* @__PURE__ */ jsx(Link, {
