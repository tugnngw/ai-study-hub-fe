...
import { t as Route } from "./reset-password-B_jL2fCI.js";
      ...
      /* @__PURE__ */ jsxs(CardHeader, {
        children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, {
            children: "Tạo mật khẩu mới cho tài khoản của bạn",
          }),
        ],
      }),
      /* @__PURE__ */ jsxs(CardContent, {
        children: [
          /* @__PURE__ */ jsxs("form", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Button, {
                type: "submit",
                className:
                  "w-full bg-gradient-brand shadow-brand hover:opacity-90",
                disabled: loading,
          ...
          /* @__PURE__ */ jsxs(Link, {
            to: "/auth/login",
            className:
              "mt-4 flex items-center justify-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors",
            children: [
