...
import { t as Route } from "./shared._shareId-DjBqLGRZ.js";
...
import { p as useFolders } from "./queries-CXmbvism.js";
	...
	return useQuery({
		...
		queryFn: async () => {
			...
			if (share) return {
				...
				documentId: share.documentId || void 0
			};
			...
			if (ownedShare) return {
				...
				isDocument: ownedShare.isDocument ?? false,
				documentId: ownedShare.documentId || void 0
			};
...
function SharedWorkspace({ shareToken, docId }) {
	...
	const documentId = folderInfo.data?.documentId;
	const docsQuery = useSharedDocuments(folderId);
	const singleDocQuery = useSharedDocument(documentId ?? "");
	...
	useEffect(() => {
		if (isDocument && documentId && !docId && singleDocQuery.data) navigate({
			to: "/shared/$shareId",
			params: { shareId: shareToken },
			search: { docId: documentId },
			replace: true
		});
	}, [
		isDocument,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: isDocument ? singleDocQuery.isLoading ? /* @__PURE__ */ jsx(Skeleton, { className: "h-9 rounded-lg" }) : singleDocQuery.data ? /* @__PURE__ */ jsxs("button", {
								className: "flex items-center gap-2 text-sm px-2.5 py-2 rounded-lg transition-colors w-full text-left bg-gradient-brand text-white font-medium shadow-soft",
								children: [/* @__PURE__ */ jsx(FileText, { className: "h-3.5 w-3.5 shrink-0" }), /* @__PURE__ */ jsx("span", {
									className: "truncate",
									children: singleDocQuery.data.title
								})]
							}) : /* @__PURE__ */ jsx("div", {
								className: "text-xs text-muted-foreground px-2",
								children: "Không tìm thấy tài liệu"
			...
			/* @__PURE__ */ jsx("section", {
				...
				}) : isDocument ? /* @__PURE__ */ jsx("div", {
					className: "flex-1 flex items-center justify-center p-8",
					children: singleDocQuery.isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "h-8 w-8 animate-spin text-primary" }) : /* @__PURE__ */ jsx("div", {
