import { o as quizApi } from "./realApi-x4p-l9IU.js";
import { t as Route } from "./ai-Ce5R1NZt.js";
...
import { t as DocumentActionsMenu } from "./document-actions-menu-D9F8VkW9.js";
import { n as aiUnavailableReason, r as isAIAvailable, t as DocumentViewer } from "./DocumentViewer-DasZim9t.js";
import { t as Progress } from "./progress-BS38uVhb.js";
import { t as DocumentStatusBadge } from "./document-status-badge-D0WrkEtj.js";
import { useCallback, useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { AlertTriangle, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, FileText, FolderClosed, FolderX, Infinity as Infinity$1, Info, Loader2, MessageSquare, Plus, RefreshCw, RotateCcw, Send, Shuffle, Sparkles, Trash2, Upload } from "lucide-react";
...
function QuizViewer({ quizzes, isLoading }) {
	...
	const submitToBackend = useCallback(async () => {
		try {
			...
			for (const quiz of quizzes) {
				const payload = (quiz.questions || []).map((q) => q.id).filter((id) => answers.has(id)).map((id) => ({
					questionId: String(id),
					selectedAnswer: answers.get(id)
				}));
	...
	if (finished) return /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: options.map((opt) => {
					...
					return /* @__PURE__ */ jsx("button", {
						...
						className: cn("w-full flex items-center gap-3 p-4 rounded-xl border-2 text-left transition-all", isSelected && "border-indigo-400 bg-indigo-50 dark:bg-indigo-950", !isSelected && "border-border bg-card hover:border-indigo-300 hover:bg-accent"),
						children: /* @__PURE__ */ jsx("span", {
