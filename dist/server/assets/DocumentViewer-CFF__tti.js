import { r as tokenStore, t as API_BASE } from "./api-vGJ7qemV.js";
...
var PdfViewer = ({ url, fileName = "document.pdf", className, documentId }) => {
      ...
      try {
        ...
        if (documentId)
          try {
            ...
            if (downloadResp.ok)
              if (
                (downloadResp.headers.get("content-type") || "").includes(
                  "json",
                )
              ) {
                const data = await downloadResp.json();
                const signedUrl =
                  data?.url || data?.data?.url || data?.signedUrl;
                if (signedUrl)
                  try {
  ...
  useEffect(() => {
    ...
    pdfDoc.getPage(pageNumber).then((page) => {
      const fitScale =
        (containerWidth / page.getViewport({ scale: 1 }).width) * 0.95;
      setScale(Math.min(Math.max(fitScale, 0.25), 3));
    });
  }, [pdfDoc, pageNumber]);
  const handleZoom = (direction) => {
    if (direction === "fit") handleFitToWidth();
    else if (direction === "in") setScale((prev) => Math.min(prev + 0.25, 3));
    else setScale((prev) => Math.max(prev - 0.25, 0.25));
  };
  ...
  const Toolbar = /* @__PURE__ */ jsxs("div", {
    className:
      "flex items-center justify-between px-4 py-2 border-b border-border bg-muted/30 shrink-0 flex-wrap gap-1",
    children: [
      /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Input, {
            ...
            onChange: (e) => {
              setScale(
                Math.min(Math.max(Number(e.target.value) || 25, 25), 300) / 100,
              );
            },
        ...
        children: loading
          ...
          : /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", {
                  className:
                    "absolute bottom-2 right-2 bg-black/60 text-white text-[10px] px-2 py-0.5 rounded-full",
...
var DocxViewer = ({ url, fileName = "document.docx", className }) => {
  ...
  const fetchAndRender = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        isCloudinary && processedUrl ? processedUrl : url,
        {
          method: "GET",
          headers: {
            Accept:
      ...
      if (
        isCloudinary &&
        (errorMsg.includes("HTTP 4") || errorMsg.includes("fetch"))
      )
        setError(
  ...
  const Toolbar = /* @__PURE__ */ jsxs("div", {
    className:
      "flex items-center justify-between px-4 py-2 border-b border-border bg-muted/30 shrink-0",
    children: [
      /* @__PURE__ */ jsx("span", {
      ...
      !loading &&
        ...
        /* @__PURE__ */ jsx("div", {
          ...
          children: /* @__PURE__ */ jsx("div", {
            ref: containerRef,
            className:
              "prose prose-sm max-w-none dark:prose-invert prose-img:max-w-full prose-img:h-auto",
            style: {
              fontSize: "14px",
              lineHeight: "1.6",
            },
      ...
      !loading &&
        ...
        /* @__PURE__ */ jsx("div", {
          ...
          children: /* @__PURE__ */ jsx("pre", {
            className:
              "whitespace-pre-wrap font-mono text-sm leading-relaxed text-foreground break-words",
            children: content,
          }),
        }),
    ],
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("p", {
            ...
            children: [
              "Loại tệp không được hỗ trợ để xem: ",
              /* @__PURE__ */ jsx("strong", { children: detectedType }),
            ],
          }),
          /* @__PURE__ */ jsxs("div", {
...
var DocumentViewer = ({ document, className }) => {
  ...
  switch (fileType) {
    ...
    default:
      console.log(
        "[Debug Flow] DocumentViewer: Rendering UnsupportedFileViewer",
      );
