...
import { E as useRagChat, U as useUploadDocument, c as useDocumentsByFolder, f as useFolder, l as useDownloadDocument, o as useDocument, r as useDeleteDocument } from "./queries-BOxd9l6F.js";
...
import { a as statusLabel, n as aiUnavailableReason, r as isAIAvailable, t as DocumentViewer } from "./DocumentViewer-BRNxCtPs.js";
import { t as DocumentStatusBadge } from "./document-status-badge-BNZIDwVk.js";
import { forwardRef, useEffect, useMemo, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { AlertTriangle, ChevronLeft, ChevronRight, Download, ExternalLink, FileText, Loader2, RotateCw, Send, Sparkles, Trash2, Upload, X } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h2", {
								...
								className: `text-xs ${notes.length > 2e3 ? "text-destructive" : "text-muted-foreground"}`,
								children: [notes.length, " / 2000"]
							})]
						}),
				...
				}) : tab === "flashcards" ? /* @__PURE__ */ jsx(FlashcardsTab, { title: doc.data?.title ?? "" }) : null
			}),
			docId && /* @__PURE__ */ jsxs("div", {
