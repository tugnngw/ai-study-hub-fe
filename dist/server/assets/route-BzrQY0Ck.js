...
import { a as useDocument, o as useDocuments } from "./queries-FJFABj7o.js";
import {
...
function AppShell({ children }) {
  ...
  const openDocId = search?.docId ? Number(search.docId) : void 0;
  ...
  const isFolderDetail =
    pathname.startsWith("/folders/") || pathname.startsWith("/documents/");
            ...
            children: [
              /* @__PURE__ */ jsxs(Link, {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", {
                    className:
                      "h-9 w-9 rounded-xl bg-gradient-brand flex items-center justify-center shadow-brand group-hover:scale-105 transition-transform shrink-0",
          ...
          /* @__PURE__ */ jsxs("nav", {
            ...
            children: [
              !collapsed &&
                /* @__PURE__ */ jsx("div", {
                  className:
                    "text-[10px] font-semibold tracking-wider text-muted-foreground px-3 pt-2 pb-1.5",
                  children: "WORKSPACE",
                }),
              nav.map((item) => {
          ...
          !collapsed &&
            /* @__PURE__ */ jsx("div", {
              ...
              children: /* @__PURE__ */ jsxs("div", {
                className:
                  "rounded-xl border border-sidebar-border bg-card/60 p-3.5 space-y-2.5",
                children: [
                  /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs("header", {
            className:
              "h-16 border-b border-border/60 bg-background/70 backdrop-blur-xl flex items-center px-4 md:px-6 gap-3 sticky top-0 z-30",
            children: [
              /* @__PURE__ */ jsx(Link, {
                to: "/dashboard",
                    ...
                    : /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx(Input, {
                            ...
                            className:
                              "pl-9 h-9 bg-muted/50 border-transparent focus-visible:bg-card focus-visible:border-input",
                          }),
                        ],
                      }),
              }),
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx("button", {
                    onClick: toggleTheme,
                    className:
                      "h-9 w-9 flex items-center justify-center hover:bg-accent rounded-full transition-colors",
                    title:
                      theme === "dark"
                    ...
                    children: [
                      /* @__PURE__ */ jsx(DropdownMenuTrigger, {
                        ...
                        children: /* @__PURE__ */ jsxs("button", {
                          className:
                            "flex items-center gap-2 hover:bg-accent rounded-full pr-3 pl-1 py-1 transition-colors",
                          children: [
                            /* @__PURE__ */ jsx("div", {
                              className:
                                "h-8 w-8 rounded-full bg-gradient-brand text-white flex items-center justify-center text-sm font-semibold shadow-soft",
                              children: initial,
                            }),
                            /* @__PURE__ */ jsxs("div", {
                              className:
                          ...
                          /* @__PURE__ */ jsx(DropdownMenuLabel, {
                            ...
                            children: /* @__PURE__ */ jsxs("div", {
                              ...
                              children: [
                                /* @__PURE__ */ jsx("div", {
                                  className:
                                    "h-10 w-10 rounded-full bg-gradient-brand text-white flex items-center justify-center font-semibold",
                                  children: initial,
                                }),
                                /* @__PURE__ */ jsxs("div", {
                                  className: "min-w-0",
          ...
          /* @__PURE__ */ jsx("div", {
            className:
              "md:hidden border-b border-border bg-card/60 backdrop-blur-md",
