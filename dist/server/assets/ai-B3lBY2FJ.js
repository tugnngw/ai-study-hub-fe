import { t as Route } from "./ai-1OyGWVad.js";
...
import { C as useQuota, D as useRagStatus, E as useRagSessionDetail, F as useSummary, S as useQuizByDocument, T as useRagSession, a as useDeleteRagSession, c as useDocumentsByFolder, d as useFlashcardsByDocument, f as useFolder, g as useGenerateSummary, h as useGenerateQuiz, m as useGenerateFlashcards, o as useDocument, p as useFolders, w as useRagChat, x as useProcessRag, z as useUploadDocument } from "./queries-DWCqaZ92.js";
...
import { t as DocumentActionsMenu } from "./document-actions-menu-CJ4ADZ1I.js";
...
function QuotaDisplay() {
	...
	return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			className: "space-y-3",
			children: [renderQuotaBar("Flashcard", flashcardLimit, flashcardRemaining), renderQuotaBar("Câu hỏi quiz", questionLimit, questionRemaining)]
		})]
	}) });
}
//#endregion
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					}) : aiStatus === "FAILED" ? /* @__PURE__ */ jsxs("div", {
						className: "flex-1 flex flex-col items-center justify-center gap-4 p-8",
						children: [/* @__PURE__ */ jsx("p", {
