...
import { t as adminKeys } from "./adminKeys-CnFEP5Pr.js";
import { t as adminDocumentApi } from "./documentApi-DFNsWy7x.js";
import { useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { CheckCircle2, FileText, RotateCcw, Search, Trash2, XCircle } from "lucide-react";
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx(TableCell, {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [activeTab === "pending" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Button, {
									variant: "outline",
									size: "sm",
									...
									onClick: () => restoreDocument.mutate(d.id, { onSuccess: () => toast.success("Đã khôi phục file") }),
									...
									onClick: () => {
										if (window.confirm("Xóa file này?")) deleteDocument.mutate(d.id, { onSuccess: () => toast.success("Đã xóa file") });
									},
