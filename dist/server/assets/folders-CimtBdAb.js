...
import { b as useUpdateFolder, f as useFolders, i as useDeleteFolder, n as useCreateFolder } from "./queries-CwH5qVX2.js";
...
function FoldersPage() {
	...
	const filtered = (data ?? []).filter((f) => f.name.toLowerCase().includes(query.toLowerCase()));
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			isLoading ? /* @__PURE__ */ jsx("div", {
				...
				className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3",
				children: filtered.map((f) => /* @__PURE__ */ jsx(Card, {
