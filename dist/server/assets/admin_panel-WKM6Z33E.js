...
var dashboardApi = {
	...
	getRecentActivity: (limit = 15) => api(`/api/admin/dashboard/activity?limit=${limit}`)
};
//#endregion
...
function useAdminActivity(limit = 15) {
	return useQuery({
...
var activityIcon = {
	USER_REGISTER: /* @__PURE__ */ jsx(UserPlus, { className: "h-4 w-4" }),
	USER_UPGRADE: /* @__PURE__ */ jsx(UserPlus, { className: "h-4 w-4" }),
	DOCUMENT_UPLOAD: /* @__PURE__ */ jsx(Upload, { className: "h-4 w-4" }),
	DOCUMENT_DELETE: /* @__PURE__ */ jsx(Trash, { className: "h-4 w-4" }),
	DOCUMENT_DOWNLOAD: /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }),
	DOCUMENT_RESTORE: /* @__PURE__ */ jsx(Upload, { className: "h-4 w-4" }),
	PAYMENT_SUCCESS: /* @__PURE__ */ jsx(Flag, { className: "h-4 w-4" }),
	PAYMENT_FAILED: /* @__PURE__ */ jsx(Flag, { className: "h-4 w-4" })
};
var activityTone = {
...
function calculateTrend(lastWeek, prevWeek) {
...
var AdminDashboardPage = () => {
	...
	if (statsError || activityError) return /* @__PURE__ */ jsx("div", {
		className: "flex items-center justify-center h-96",
		children: /* @__PURE__ */ jsx("p", {
			className: "text-destructive",
			children: "Không thể tải dữ liệu dashboard"
		})
	});
	const usersTrend = stats ? calculateTrend(stats.usersLastWeek, stats.usersPrevWeek) : void 0;
	const docsTrend = stats ? calculateTrend(stats.docsLastWeek, stats.docsPrevWeek) : void 0;
	const downloadsTrend = stats ? calculateTrend(stats.downloadsLastWeek, stats.downloadsPrevWeek) : void 0;
