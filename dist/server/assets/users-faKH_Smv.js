...
import { t as adminUserApi } from "./userApi-CRLQrbAS.js";
import { useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { KeyRound, Lock, Search, Trash2, Unlock } from "lucide-react";
...
function useResetPassword() {
	const qc = useQueryClient();
	return useMutation({
		mutationFn: ({ id, newPassword }) => adminUserApi.resetPassword(id, newPassword),
		onSuccess: () => qc.invalidateQueries({ queryKey: adminKeys.users() })
	});
}
//#endregion
...
var AdminUsersPage = () => {
	...
	const doReset = async () => {
		...
		if (newPwd.length < 8) return toast.error("Mật khẩu phải có ít nhất 8 ký tự");
		try {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs(Button, {
								...
								children: [/* @__PURE__ */ jsx(KeyRound, { className: "h-3.5 w-3.5" }), " Đặt lại mật khẩu"]
							}),
							/* @__PURE__ */ jsxs(Button, {
								variant: "outline",
								size: "sm",
		...
		children: /* @__PURE__ */ jsxs(DialogContent, { children: [
			/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Đặt lại mật khẩu" }), /* @__PURE__ */ jsxs(DialogDescription, { children: [
				"Nhập mật khẩu mới cho ",
				resetTarget?.name ?? "người dùng",
				" (",
			...
			/* @__PURE__ */ jsxs(DialogFooter, { children: [/* @__PURE__ */ jsx(Button, {
				...
				children: resetPassword.isPending ? "Đang đặt lại…" : "Đặt lại mật khẩu"
			})] })
		] })
	})] });
};
