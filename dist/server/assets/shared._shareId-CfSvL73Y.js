...
import { t as Route } from "./shared._shareId-BXQjqrWo.js";
import { m as useFolders } from "./queries-BOxd9l6F.js";
...
import { t as DocumentViewer } from "./DocumentViewer-BRNxCtPs.js";
			...
			/* @__PURE__ */ jsxs("aside", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						children: [/* @__PURE__ */ jsx(Save, { className: "h-4 w-4 mr-1.5" }), isDocument ? "Lưu tài liệu này" : "Lưu vào thư mục của tôi"]
					}),
					/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: selectedDoc ? /* @__PURE__ */ jsx(DocumentViewer, {
					...
					children: docsQuery.isLoading ? /* @__PURE__ */ jsx("div", {
						...
						className: "grid grid-cols-2 sm:grid-cols-3 gap-4",
						children: [docs.map((d) => /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Label, {
										...
										className: `text-xs ml-auto ${saveTitle.length > 255 ? "text-destructive" : "text-muted-foreground"}`,
										children: [saveTitle.length, " / 255"]
									})]
								}), /* @__PURE__ */ jsx(Input, {
									id: "save-title",
									value: saveTitle,
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Label, {
										...
										className: `text-xs ml-auto ${saveDesc.length > 500 ? "text-destructive" : "text-muted-foreground"}`,
										children: [saveDesc.length, " / 500"]
									})]
