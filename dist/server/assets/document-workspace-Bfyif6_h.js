...
function DocumentWorkspace({ folderId, docId }) {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className:
      "grid grid-cols-1 lg:grid-cols-[280px_1fr_340px] gap-4 h-[calc(100vh-9rem)]",
    children: [
      /* @__PURE__ */ jsxs("aside", {
        className:
          "hidden lg:flex flex-col bg-card border border-border rounded-2xl p-4 overflow-hidden shadow-soft",
        children: [
          /* @__PURE__ */ jsxs(Link, {
            to: "/folders",
            className:
              "flex items-center gap-1.5 text-primary font-medium text-sm mb-4 hover:gap-2.5 transition-all",
            children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            className:
              "rounded-xl bg-gradient-soft p-3 border border-border/50",
            children: [
              /* @__PURE__ */ jsx("div", {
                className:
                  "text-[10px] font-semibold tracking-wider text-muted-foreground mb-1",
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("div", {
                className:
                  "text-[10px] font-semibold tracking-wider text-muted-foreground mb-2 px-1",
          ...
          /* @__PURE__ */ jsxs(Button, {
            ...
            size: "sm",
            className:
              "mt-4 justify-start border-dashed hover:border-primary hover:text-primary hover:bg-primary/5",
            onClick: () => setUploadOpen(true),
            children: [
              /* @__PURE__ */ jsx(Upload, { className: "h-3.5 w-3.5 mr-2" }),
              " Tải lên tài liệu",
            ],
          }),
        ],
      ...
      /* @__PURE__ */ jsxs("section", {
        className:
          "bg-card border border-border rounded-2xl flex flex-col overflow-hidden shadow-soft",
        children: [
          /* @__PURE__ */ jsx("div", {
            className:
              "flex gap-1.5 p-3 border-b border-border bg-gradient-soft overflow-x-auto",
            children: [
              {
                id: "original",
                label: "Nội dung gốc",
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsx("div", {
                                      ...
                                      children: /* @__PURE__ */ jsx("div", {
                                        className:
                                          "h-16 w-16 rounded-xl bg-gradient-soft flex items-center justify-center group-hover:bg-gradient-brand transition-colors",
                                        children: /* @__PURE__ */ jsx(
                                          FileText,
                                          {
                                            className:
                                              "h-8 w-8 text-primary group-hover:text-white",
                                          },
                                        ),
                                      }),
                                    }),
                                    /* @__PURE__ */ jsx("div", {
                                      className:
                                        "text-xs font-medium text-foreground truncate w-full",
                                      children: d.title,
                                    }),
                                  ],
                                },
                    ...
                    : tab === "notes"
                      ? /* @__PURE__ */ jsxs("div", {
                          ...
                          children: [
                            /* @__PURE__ */ jsxs("div", {
                              className:
                                "flex flex-wrap gap-1 border border-border rounded-lg px-2 py-1.5 text-xs text-muted-foreground bg-muted/40",
                              children: [
                                /* @__PURE__ */ jsx("span", {
                                  className:
                                    "px-2 py-0.5 hover:bg-accent rounded cursor-pointer font-bold",
                                  children: "B",
                                }),
                                /* @__PURE__ */ jsx("span", {
                                  className:
                                    "px-2 py-0.5 hover:bg-accent rounded cursor-pointer italic",
                                  children: "I",
                                }),
                                /* @__PURE__ */ jsx("span", {
                                  className:
                                    "px-2 py-0.5 hover:bg-accent rounded cursor-pointer underline",
                                  children: "U",
                                }),
                                /* @__PURE__ */ jsx("span", {
                                  className:
                                    "px-2 py-0.5 hover:bg-accent rounded cursor-pointer",
                                  children: "H1",
                                }),
                                /* @__PURE__ */ jsx("span", {
                                  className:
                            ...
                            /* @__PURE__ */ jsx("h2", {
                              className:
                                "text-xl font-bold text-gradient-brand font-display",
                              children: "Ghi chú AI",
                            }),
                      ...
                      : tab === "summary"
                        ...
                        : tab === "flashcards"
                          ? /* @__PURE__ */ jsx(FlashcardsTab, {
                              title: doc.data?.title ?? "",
                            })
                          : /* @__PURE__ */ jsx(QuizzesTab, {
                              title: doc.data?.title ?? "",
                            }),
          }),
          docId &&
            ...
            children: [
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", {
                    className:
                      "h-8 w-8 rounded-lg bg-gradient-brand flex items-center justify-center",
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              messages.length === 0
                ? /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("div", {
                        className:
                          "h-12 w-12 rounded-2xl bg-gradient-soft flex items-center justify-center mb-3",
                        children: /* @__PURE__ */ jsx(Sparkles, {
              ...
              ask.isPending &&
                /* @__PURE__ */ jsxs("div", {
                  className:
                    "text-sm bg-muted rounded-2xl rounded-bl-md px-3.5 py-2.5 max-w-[88%] inline-flex items-center gap-1.5",
                  children: [
                    /* @__PURE__ */ jsx("span", {
                      className:
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", {
              className: "space-y-2",
              children: [
                /* @__PURE__ */ jsx(Label, { children: "Tiêu đề" }),
                /* @__PURE__ */ jsx(Input, {
                  value: title,
            ...
            /* @__PURE__ */ jsxs("div", {
              className: "space-y-2",
              children: [
                /* @__PURE__ */ jsx(Label, { children: "Mô tả" }),
                /* @__PURE__ */ jsx(Textarea, {
                  value: description,
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(Button, {
            ...
            children: [
              /* @__PURE__ */ jsx(RotateCw, { className: "h-3.5 w-3.5 mr-2" }),
              " Tạo lại",
            ],
          }),
        ],
      ...
      loading
        ...
        : /* @__PURE__ */ jsxs(Fragment, {
            children: [
              /* @__PURE__ */ jsxs("div", {
                className:
                  "rounded-lg border border-primary/20 bg-brand-soft/60 p-4",
                children: [
                  /* @__PURE__ */ jsx("div", {
                      ...
                      /* @__PURE__ */ jsxs(
                        "li",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx("span", {
                              className:
                                "h-5 w-5 shrink-0 rounded-full bg-gradient-brand text-white text-xs font-bold flex items-center justify-center",
                              children: i + 1,
                            }),
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("button", {
        ...
        className:
          "w-full min-h-[220px] rounded-xl border-2 border-primary/20 bg-gradient-soft p-8 flex flex-col items-center justify-center text-center transition-all hover:shadow-md",
        children: [
          /* @__PURE__ */ jsx("div", {
            className:
              "text-[11px] uppercase tracking-wider text-muted-foreground mb-3",
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsxs("p", {
                className: "text-xs text-muted-foreground mt-1",
                children: ["Câu hỏi trắc nghiệm từ “", title, "”"],
              }),
            ],
          }),
          submitted &&
