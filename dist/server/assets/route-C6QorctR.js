...
import { A as useSemesters, P as useSubjectsBySemester, o as useDocument, p as useFolders, s as useDocuments, z as useUploadDocument } from "./queries-DWCqaZ92.js";
...
import { AlertCircle, BookOpen, Cloud, Crown, Database, FileText, FolderKanban, GraduationCap, LayoutDashboard, Loader2, LogOut, Moon, PanelLeft, PanelLeftClose, Receipt, Search, Settings, Sparkles, Sun, Trash2, Upload, User, Users, X } from "lucide-react";
...
function UploadDocumentDialog({ open, onOpenChange, defaultFolderId }) {
	...
	useEffect(() => {
		if (open && defaultFolderId) setFolderId(defaultFolderId);
	}, [open, defaultFolderId]);
	useEffect(() => {
		if (folderId) {
			const folder = (allFolders.data ?? []).find((f) => f.id === folderId);
			if (folder && folder.subjectId !== subjectId) setFolderId("");
		}
	}, [
		subjectId,
		folderId,
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									}), folderId && /* @__PURE__ */ jsx("span", {
										className: "text-xs text-muted-foreground",
										children: "Auto-set from folder"
									})]
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, {
										...
										children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select a semester" })
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, {
										className: cn(!!folderId && "cursor-not-allowed opacity-50"),
										children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select a subject" })
									}), /* @__PURE__ */ jsx(SelectContent, { children: (subjects.data ?? []).map((s) => /* @__PURE__ */ jsx(SelectItem, {
										value: s.id,
										children: s.name
									}, s.id)) })]
								})]
