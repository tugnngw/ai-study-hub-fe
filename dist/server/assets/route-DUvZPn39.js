...
import { I as useSubjects, N as useSemesters, T as useQuota, m as useFolders, o as useDocument, s as useDocuments } from "./queries-BOxd9l6F.js";
...
function AppShell({ children }) {
	...
	const pct = quota?.storageLimitBytes ? Math.min(100, Math.round(quota.storageUsedBytes / quota.storageLimitBytes * 100)) : 0;
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											}), user?.role !== "ADMIN" && user?.plan && user.plan.toUpperCase() !== "FREE" && /* @__PURE__ */ jsx("span", {
...
function AuthLayout() {
	...
	useEffect(() => {
		if (!isInitializing && !isAuthenticated) window.location.href = "/auth/login";
	}, [
		isAuthenticated,
		isInitializing,
		user
	...
	if (isInitializing) return /* @__PURE__ */ jsx("div", {
