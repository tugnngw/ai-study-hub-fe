...
import { t as OtpVerification } from "./otp-verification-fxX2ec2m.js";
...
var emailSchema = z.string().email("Email không hợp lệ").max(255, "Tối đa 255 ký tự");
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Label, {
							...
							className: `text-xs ml-auto ${email.length > 255 ? "text-destructive" : "text-muted-foreground"}`,
							children: [email.length, " / 255"]
						})]
					}),
					/* @__PURE__ */ jsx(Input, {
						id: "email",
