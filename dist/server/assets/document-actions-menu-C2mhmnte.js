import { L as useSubjectsBySemester, N as useSemesters, V as useUpdateDocument, m as useFolders, r as useDeleteDocument, v as useMySubmittedReports } from "./queries-BOxd9l6F.js";
...
import { Flag, FolderOpen, MoreVertical, Pencil, Pin, PinOff, Share2, Trash2 } from "lucide-react";
...
function DocumentActionsMenu({ documentId, folderId, title, status, description, subjectId, className, iconClassName }) {
	...
	const hasPendingAppeal = (myReports.data ?? []).some((r) => String(r.documentId) === String(documentId) && r.status === "pending");
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
			...
			onClick: (e) => e.stopPropagation(),
			children: [
				!isBanned && /* @__PURE__ */ jsxs(Fragment, { children: [
				...
				isBanned && /* @__PURE__ */ jsxs(DropdownMenuItem, {
					onClick: () => {
					...
					children: [/* @__PURE__ */ jsx(Flag, { className: "h-3.5 w-3.5 mr-2" }), hasPendingAppeal ? "Appeal Pending" : "Appeal"]
				}),
				/* @__PURE__ */ jsxs(DropdownMenuItem, {
