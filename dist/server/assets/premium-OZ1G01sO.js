...
import { b as usePlans, v as useMySubscription } from "./queries-DWCqaZ92.js";
...
var getPlanRank = (planName) => {
	return RANK[planName.toUpperCase().replace(/\s+V\d+$/, "").trim()] ?? 0;
};
function PremiumUpgradePage() {
	...
	const isUpgrade = (p) => getPlanRank(p.name) > getPlanRank(currentPlan);
	const isDowngrade = (p) => getPlanRank(p.name) < getPlanRank(currentPlan);
	const quote = useMemo(() => {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: "Vui lòng quét mã QR trong vòng 1 phút"
								})]
							}),
							/* @__PURE__ */ jsx("div", {
								className: "border p-2 rounded-lg bg-white",
								children: paymentInfo?.checkoutUrl && /* @__PURE__ */ jsx("iframe", {
