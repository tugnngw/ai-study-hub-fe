...
import {
  f as useFolders,
  i as useDeleteFolder,
  n as useCreateFolder,
  y as useUpdateFolder,
...
import { FolderKanban, Pencil, Plus, Search, Star, Trash2 } from "lucide-react";
...
var AlertDialogContent = React.forwardRef(({ className, ...props }, ref) =>
...
var AlertDialogTitle = React.forwardRef(({ className, ...props }, ref) =>
...
var AlertDialogDescription = React.forwardRef(({ className, ...props }, ref) =>
...
var AlertDialogAction = React.forwardRef(({ className, ...props }, ref) =>
...
var AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) =>
      ...
      isLoading
        ? /* @__PURE__ */ jsx("div", {
            ...
            children: Array.from({ length: 6 }).map((_, i) =>
              /* @__PURE__ */ jsx(Skeleton, { className: "h-32" }, i),
            ),
          })
        : filtered.length === 0
          ? /* @__PURE__ */ jsx(Card, {
                  ...
                  Card,
                  {
                    ...
                    children: [
                      isStarred(f.id) &&
                        /* @__PURE__ */ jsx(Star, {
                          className:
                            "h-3.5 w-3.5 absolute top-3 right-3 fill-amber-400 text-amber-400",
                        }),
                      /* @__PURE__ */ jsxs(CardContent, {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("div", {
                            className:
                              "flex justify-end gap-1 mt-3 opacity-0 group-hover:opacity-100 transition-opacity",
                            children: [
                              /* @__PURE__ */ jsx(Button, {
                                size: "sm",
                                variant: "ghost",
                                onClick: () => toggleStar(f.id),
                                title: isStarred(f.id)
                                  ? "Bỏ đánh dấu sao"
                                  : "Đánh dấu sao",
        ...
        /* @__PURE__ */ jsxs(DialogHeader, {
          children: [
            /* @__PURE__ */ jsx(DialogTitle, {
              children: folder ? "Edit folder" : "New folder",
            }),
