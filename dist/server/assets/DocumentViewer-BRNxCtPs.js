import { r as useDeleteDocument, v as useMySubmittedReports } from "./queries-BOxd9l6F.js";
import { n as formatBytes, t as cn } from "./utils-CZKD4yH6.js";
import { t as Button } from "./button-C90jjaif.js";
import { t as ConfirmDeleteDialog } from "./confirm-delete-dialog-D9S1PU__.js";
import { t as ReportDocumentDialog } from "./report-document-dialog-BCjQHN3a.js";
import { t as Card } from "./card-D4JpMjWP.js";
import { useCallback, useEffect, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { AlertTriangle, Clock, Download, ExternalLink, File, FileText, Loader2, RotateCw, Trash2, XCircle } from "lucide-react";
...
var DocumentViewer = ({ document, className, onReport }) => {
	...
	const hasPendingAppeal = (myReports.data ?? []).some((r) => String(r.documentId) === String(document.id) && r.status === "pending");
	...
	if (document.status === "BANNED") return /* @__PURE__ */ jsxs(Card, {
		className: `flex flex-col overflow-hidden min-h-0 ${className || ""}`,
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "flex-1 flex flex-col items-center justify-center p-8",
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "text-red-500",
							children: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-12 w-12 mx-auto" })
						}),
						/* @__PURE__ */ jsx("p", {
							className: "text-lg font-medium text-red-600",
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Tài liệu này đã bị quản trị viên khóa vì vi phạm quy định và không còn có thể sử dụng."
						}),
						document.rejectReason && /* @__PURE__ */ jsxs("div", {
							className: "bg-red-50 border border-red-200 rounded-lg p-3 mt-2 text-left",
							children: [/* @__PURE__ */ jsx("p", {
								className: "text-sm font-medium text-red-800 mb-1",
								children: "Lý do:"
							}), /* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							className: "text-sm text-muted-foreground text-left pt-2 border-t border-border/60",
							children: [
								/* @__PURE__ */ jsx("p", {
									className: "font-medium mb-1",
									children: "Bạn vẫn có thể:"
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-1.5 text-destructive",
									children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("button", {
										type: "button",
										onClick: () => setDeleteOpen(true),
										className: "underline decoration-destructive/40 underline-offset-2 hover:text-destructive/80",
										children: "Xóa tài liệu"
									})]
								}),
								hasPendingAppeal ? /* @__PURE__ */ jsx("div", {
									className: "flex items-center gap-1.5 text-amber-600 mt-1.5 text-xs font-medium",
									children: "Kháng cáo đang chờ xử lý"
								}) : /* @__PURE__ */ jsx("div", {
									className: "flex items-center gap-1.5 text-primary mt-1.5",
									children: /* @__PURE__ */ jsx("button", {
										type: "button",
