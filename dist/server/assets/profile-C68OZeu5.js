import { n as authApi } from "./realApi-zSE4Ojk_.js";
...
import { F as useSharedDocuments, m as useFolders, s as useDocuments, y as useMySubscription } from "./queries-gXAr1tOQ.js";
...
function ProfilePage() {
	...
	const planRemainingDays = useMySubscription().data?.daysRemaining ?? 0;
	const save = async (e) => {
		e.preventDefault();
		setSaving(true);
		try {
