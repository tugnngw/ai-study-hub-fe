...
import { t as Route } from "./reset-password-CDBUMEY8.js";
...
function ResetPasswordPage() {
	...
	useEffect(() => {
		if (email || otp) window.history.replaceState({}, "", "/auth/reset-password");
	}, [email, otp]);
		...
		children: [/* @__PURE__ */ jsxs(CardHeader, { children: [/* @__PURE__ */ jsx(CardTitle, {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Button, {
					...
					disabled: loading,
					children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }), "Đang lưu..."] }) : "Đổi mật khẩu"
				})
			]
		}), /* @__PURE__ */ jsxs(Link, {
			to: "/auth/login",
