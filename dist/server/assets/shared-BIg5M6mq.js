...
import { n as DropdownMenuContent, o as DropdownMenuTrigger, r as DropdownMenuItem, t as DropdownMenu } from "./dropdown-menu-Dd2HU7wv.js";
...
import { t as ReportDocumentDialog } from "./report-document-dialog-BCjQHN3a.js";
...
import { i as TabsTrigger, r as TabsList, t as Tabs } from "./tabs-CK6O_EHq.js";
import { t as sharesApi } from "./shareApi-B8OBrt-r.js";
import { useEffect, useMemo, useState } from "react";
import { Outlet, useMatchRoute, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { ChevronLeft, ChevronRight, Download, FileText, Flag, Folder, FolderOpen, Link2, MoreHorizontal, Search, Star, Trash2 } from "lucide-react";
...
function ItemIcon({ isDocument }) {
	if (isDocument) return /* @__PURE__ */ jsx("div", {
		className: "h-9 w-9 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center shrink-0",
		children: /* @__PURE__ */ jsx(FileText, { className: "h-4.5 w-4.5" })
	});
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(ItemIcon, { isDocument: it.isDocument }), /* @__PURE__ */ jsxs("div", {
										...
										}), /* @__PURE__ */ jsx(TooltipContent, { children: /* @__PURE__ */ jsx("p", { children: it.name }) })] }) }), /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [/* @__PURE__ */ jsx(TooltipTrigger, {
											asChild: true,
											children: /* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(PersonAvatar, { person: it.sharedBy }), /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [/* @__PURE__ */ jsx(TooltipTrigger, {
										asChild: true,
										children: /* @__PURE__ */ jsx("span", {
											className: "text-sm truncate cursor-help",
											children: it.sharedBy.name
										})
									}), /* @__PURE__ */ jsx(TooltipContent, { children: /* @__PURE__ */ jsx("p", { children: it.sharedBy.name }) })] }) })]
								}),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsx(RowMenu, { items: [
									...
									...it.isDocument && it.documentId ? [{
										icon: /* @__PURE__ */ jsx(Flag, { className: "h-4 w-4" }),
										label: "Báo cáo",
										onClick: () => {
...
function SharedByMeTable({ items, count, page, totalPages, onPage, onCopyLink, onRemove, onAppeal }) {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-3 min-w-0",
								children: [/* @__PURE__ */ jsx(ItemIcon, { isDocument: !!it.documentId }), /* @__PURE__ */ jsxs("div", {
									className: "min-w-0 flex-1",
									children: [/* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [/* @__PURE__ */ jsx(TooltipTrigger, {
										asChild: true,
										children: /* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									}), /* @__PURE__ */ jsx(TooltipContent, { children: /* @__PURE__ */ jsx("p", { children: it.sharedWith.map((w) => w.name).join(", ") || "—" }) })] }) }),
