		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("span", { children: ["Kích thước: ", fmtSize(fileSize)] }),
...
var DocumentViewer = ({ document, className }) => {
	...
	if (document.status === "COMPLETED") return /* @__PURE__ */ jsx(Card, {
		className: `flex flex-col overflow-hidden min-h-0 ${className || ""}`,
		children: /* @__PURE__ */ jsxs("div", {
			className: "flex-1 flex flex-col items-center justify-center p-8",
			children: [
				/* @__PURE__ */ jsx(Loader2, { className: "h-8 w-8 text-muted-foreground animate-spin mb-3" }),
				/* @__PURE__ */ jsx("p", {
					className: "text-sm text-muted-foreground font-medium",
					children: "Tài liệu đang chờ admin duyệt"
				}),
				/* @__PURE__ */ jsx("p", {
					className: "text-xs text-muted-foreground mt-1",
					children: "Vui lòng quay lại sau"
				})
			]
		})
	});
