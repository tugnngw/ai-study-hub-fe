import { t as cn$1 } from "./utils-BlvTLkCV.js";
...
import { E as useRagChat, H as useUploadDocument, c as useDocumentsByFolder, f as useFolder, l as useDownloadDocument, o as useDocument, r as useDeleteDocument } from "./queries-iZB6N2Qr.js";
					...
					(folderDocs.data ?? []).filter((d) => d.status?.toUpperCase() !== "BANNED").map((d) => {
						...
						return /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								...
								params: { id: folderId },
								search: { docId: d.id },
								className: cn$1("flex items-center gap-2 text-sm px-2.5 py-2 rounded-lg transition-colors", active ? "bg-gradient-brand text-white font-medium shadow-soft" : "hover:bg-accent text-foreground/90", s === "BANNED" && "opacity-50 cursor-not-allowed pointer-events-none"),
								onClick: (e) => {
									if (s === "REJECT") {
										e.preventDefault();
		...
		children: [
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						className: cn$1("font-semibold", flipped ? "text-base leading-relaxed" : "text-2xl"),
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: cards.map((_, i) => /* @__PURE__ */ jsx("div", { className: cn$1("h-1.5 rounded-full transition-all", i === idx ? "w-6 bg-gradient-brand" : "w-1.5 bg-muted") }, i))
					}),
					/* @__PURE__ */ jsxs(Button, {
						size: "sm",
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: quiz.options.map((opt, oi) => {
							...
							return /* @__PURE__ */ jsxs("button", {
								...
								className: cn$1("w-full text-left flex items-center gap-3 px-3 py-2 rounded-md border text-sm transition-colors", correct && "border-emerald-400 bg-emerald-50/60", wrong && "border-red-400 bg-red-50/60", !submitted && picked && "border-primary bg-brand-soft/60", !submitted && !picked && "border-border hover:bg-accent"),
								children: [/* @__PURE__ */ jsx("span", {
									className: cn$1("h-5 w-5 rounded-full border flex items-center justify-center text-[10px] font-bold shrink-0", correct && "bg-emerald-500 text-white border-emerald-500", wrong && "bg-red-500 text-white border-red-500", !submitted && picked && "bg-gradient-brand text-white border-transparent"),
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: HIGHLIGHTS.map((h) => /* @__PURE__ */ jsx("button", {
						...
						className: cn$1("px-2.5 py-1 text-[11px] rounded-md font-medium transition-colors", h.cls),
						children: h.label
					}, h.id))
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [messages.length === 0 ? /* @__PURE__ */ jsxs("div", {
					...
					className: cn$1("text-sm rounded-2xl px-3.5 py-2.5 max-w-[88%] leading-relaxed", m.role === "user" ? "bg-gradient-brand text-white ml-auto rounded-br-md shadow-soft" : "bg-muted text-foreground rounded-bl-md"),
					children: m.content
