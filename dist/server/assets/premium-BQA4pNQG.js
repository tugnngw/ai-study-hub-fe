...
import { Clock, Crown, FileCheck, TrendingDown, TrendingUp, Wallet, XCircle } from "lucide-react";
...
var premiumApi = {
	...
	decide: (id, decision) => api(`/api/admin/premium/requests/${id}/decision`, {
		method: "POST",
		body: { decision }
	})
};
...
var AdminPremiumPage = () => {
	...
	const filtered = useMemo(() => tab === "all" ? requests : requests.filter((r) => r.plan === tab), [requests, tab]);
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsxs(CardHeader, {
				...
				children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, {
					...
					children: [
						...
						/* @__PURE__ */ jsx(TableHead, { children: "Payment Proof" }),
					...
					return /* @__PURE__ */ jsxs(TableRow, {
						...
						children: [
							...
							/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(PlanBadge, { plan: r.plan }) }),
							/* @__PURE__ */ jsx(TableCell, {
								className: "text-muted-foreground",
