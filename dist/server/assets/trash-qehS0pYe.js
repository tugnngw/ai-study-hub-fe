					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Button, {
								...
								children: [restore.isPending || restoreFolder.isPending ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 mr-2 animate-spin" }) : /* @__PURE__ */ jsx(RotateCcw, { className: "h-3.5 w-3.5 mr-2" }), "Khôi phục"]
							}),
							/* @__PURE__ */ jsx(Button, {
								size: "sm",
								variant: "ghost",
								...
								children: erase.isPending || eraseFolder.isPending ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5" })
							})
						]
					}, d.id);
				})
