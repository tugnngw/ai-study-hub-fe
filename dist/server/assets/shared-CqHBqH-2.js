import { n as api } from "./api-CNdWN6St.js";
...
var sharesApi = {
	...
	deleteShared: (shareToken) => api(`/api/shares/${shareToken}`, { method: "DELETE" }),
...
function SharePage() {
	...
	const handleOpenWithMe = (shareToken, savedFolderId) => {
		actions.openInAI(shareToken, savedFolderId);
	};
	const handleOpenByMe = (shareToken, savedFolderId) => {
		actions.openInAI(shareToken, savedFolderId);
	};
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			...
			showWithMe && /* @__PURE__ */ jsx(SharedWithMeTable, {
				...
				onOpen: (id) => {
					handleOpenWithMe(id, s.pagedWithMe.find((it) => it.id === id)?.savedFolderId);
				},
			...
			showByMe && /* @__PURE__ */ jsx(SharedByMeTable, {
				...
				onOpen: (id) => {
					handleOpenByMe(id, s.pagedByMe.find((it) => it.id === id)?.savedFolderId);
				},
