...
import { n as useAuth } from "./auth-DuvF93uh.js";
...
import { b as usePlans, v as useMySubscription } from "./queries-CXmbvism.js";
	...
	useEffect(() => {
		...
		if (qrCodeModal && paymentInfo) {
			...
			const onVisibilityChange = () => {
				if (document.visibilityState === "visible") accountApi.me().then((u) => {
					if (u && u.plan && String(u.plan).toUpperCase() !== currentPlan) {
						clearInterval(timer);
						clearInterval(poller);
						setQrCodeModal(false);
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: "Tự động kiểm tra sau 5 giây"
								})]
							}),
							/* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsxs(Button, {
								...
								children: [/* @__PURE__ */ jsx(ExternalLink, { className: "h-4 w-4" }), " Mở trang thanh toán"]
							}),
							/* @__PURE__ */ jsx("p", {
