...
import { t as Route } from "./shared._shareId-DkSAggar.js";
...
import { t as ReportDocumentDialog } from "./report-document-dialog-DXR6FosL.js";
								...
								docs.filter((d) => d.status?.toUpperCase() !== "BANNED").map((d) => {
									return /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("button", {
											...
											className: cn("flex items-center gap-2 text-sm px-2.5 py-2 rounded-lg transition-colors flex-1 min-w-0 text-left", d.id === docId ? "bg-gradient-brand text-white font-medium shadow-soft" : "hover:bg-accent text-foreground/90"),
