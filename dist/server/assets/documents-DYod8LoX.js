...
function DocumentRow({ id, folderId, folderName, semesterName, subjectName, title, description, fileSize, status, rejectReason, pinned, onTogglePin }) {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Select, {
								...
								children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: !subjectId ? "Chọn thư mục (sẽ tự nhập kỳ & môn)" : "Chọn thư mục" }) }), /* @__PURE__ */ jsxs(SelectContent, { children: [foldersInSubject.length === 0 ? /* @__PURE__ */ jsx("div", {
									className: "px-3 py-2 text-sm text-muted-foreground",
									...
									onSelect: () => goCreateFolder(),
									children: /* @__PURE__ */ jsx("span", {
										className: "text-primary",
										children: "+ Upload vào thư mục mới..."
									})
								})] })]
							}),
