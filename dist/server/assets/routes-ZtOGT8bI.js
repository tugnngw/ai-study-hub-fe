...
function WelcomePage() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsx("header", {
        className:
          "border-b border-border/60 sticky top-0 z-30 bg-background/80 backdrop-blur-xl",
        children: /* @__PURE__ */ jsxs("div", {
          className:
            "mx-auto max-w-6xl px-4 sm:px-6 h-16 flex items-center justify-between",
          children: [
            /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsx("div", {
                  className:
                    "h-9 w-9 rounded-xl bg-gradient-brand flex items-center justify-center shadow-brand",
        ...
        children: [
          /* @__PURE__ */ jsxs("section", {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", {
                className:
                  "inline-flex items-center gap-1.5 rounded-full bg-primary/10 text-primary px-3.5 py-1.5 text-xs font-semibold",
                children: [
              ...
              /* @__PURE__ */ jsxs("h1", {
                className:
                  "mt-6 font-display text-4xl sm:text-5xl font-bold tracking-tight text-foreground",
                children: [
              ...
              /* @__PURE__ */ jsx("p", {
                ...
                children:
                  "Tải lên, tổ chức và trò chuyện với tài liệu học tập của bạn. Nhận câu trả lời tức thì được hỗ trợ bởi công nghệ AI tiên tiến.",
              }),
            ],
          }),
          /* @__PURE__ */ jsxs("section", {
              ...
              /* @__PURE__ */ jsx("div", {
                ...
                children: features.map((f) =>
                  /* @__PURE__ */ jsxs(
                    ...
                    {
                      className:
                        "rounded-xl border border-border/60 bg-card p-5 hover:shadow-md transition-shadow",
                      children: [
                        /* @__PURE__ */ jsx("div", {
                          className:
                            "h-10 w-10 rounded-lg bg-gradient-brand flex items-center justify-center shadow-brand mb-4",
          ...
          /* @__PURE__ */ jsx("section", {
            ...
            children: /* @__PURE__ */ jsxs("div", {
              className:
                "rounded-2xl bg-gradient-brand shadow-brand px-6 py-12 sm:py-16 text-center",
              children: [
                /* @__PURE__ */ jsx("h2", {
                  className:
                    "font-display text-2xl sm:text-3xl font-bold text-white",
