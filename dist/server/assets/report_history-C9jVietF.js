...
import { t as reportApi } from "./reportApi-COFMwcKK.js";
...
var AdminReportHistoryPage = () => {
	...
	const shown = activeTab === "all" ? history : tabItems.data ?? [];
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					children: "Xem lại lịch sử các báo cáo / kháng cáo đã xử lý và đang chờ"
				})] }), /* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						children: t === "reports" ? "Reports" : t === "appeals" ? "Appeals" : "Tất cả"
					}, t))
				})]
			}),
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsxs(CardHeader, {
				...
				}) }) : shown.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsxs(TableCell, {
					colSpan: 7,
					className: "h-24 text-center text-muted-foreground",
					children: [
						"Không có ",
				...
				}) }) : shown.map((item) => /* @__PURE__ */ jsxs(TableRow, { children: [
