...
import { t as DocumentActionsMenu } from "./document-actions-menu-FECHiBCQ.js";
...
function DocumentRow({ id, folderId, title, description }) {
		...
		children: [
			/* @__PURE__ */ jsx("td", {
				...
				children: /* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(FileText, { className: "h-4 w-4 text-muted-foreground" }), /* @__PURE__ */ jsx("span", {
