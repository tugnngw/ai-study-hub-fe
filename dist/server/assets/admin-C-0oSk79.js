                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("div", {
                          className:
                            "h-9 w-9 rounded-md bg-muted flex items-center justify-center",
                          children: s.device.includes("iPhone")
                        ...
                        /* @__PURE__ */ jsxs("div", {
                          children: [
                            /* @__PURE__ */ jsxs("div", {
                              ...
                              children: [
                                ...
                                s.current &&
                                  /* @__PURE__ */ jsx("span", {
                                    className:
                                      "text-[10px] bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded font-medium",
                                    children: "Hiện tại",
                                  }),
                              ],
                            }),
                            /* @__PURE__ */ jsxs("div", {
                              className: "text-xs text-muted-foreground",
                              children: [s.location, " • ", s.lastActive],
                            }),
                          ],
                        }),
                      ],
        ...
        children: /* @__PURE__ */ jsxs(DialogContent, {
          children: [
            /* @__PURE__ */ jsxs(DialogHeader, {
              children: [
                /* @__PURE__ */ jsx(DialogTitle, { children: "Đổi mật khẩu" }),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsx("div", {
                  className:
                    "h-44 w-44 bg-gradient-to-br from-muted to-muted/60 border rounded-md flex items-center justify-center text-xs text-muted-foreground",
