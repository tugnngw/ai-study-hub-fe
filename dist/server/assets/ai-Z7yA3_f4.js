import { t as Route } from "./ai-CQde0mnZ.js";
...
import { a as useDocument, b as useUploadDocument, f as useGenerateFlashcards, m as useGenerateSummary, p as useGenerateQuiz, s as useDocumentsByFolder, t as useAskRag, u as useFolder } from "./queries-CTUrUBWQ.js";
import { t as Skeleton } from "./skeleton-D9W9wFsj.js";
import { t as Textarea } from "./textarea-1llmCJsE.js";
import { t as DocumentActionsMenu } from "./document-actions-menu-CuNNsrjq.js";
import { t as DocumentViewer } from "./DocumentViewer-BfEbx-UF.js";
import { createContext, useCallback, useContext, useEffect, useMemo, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { CheckCircle2, CheckSquare, ChevronLeft, ChevronRight, FileText, FolderClosed, Loader2, RefreshCw, RotateCcw, Search, Send, Shuffle, Sparkles, Square, Upload, X, XCircle, ZoomIn, ZoomOut } from "lucide-react";
import ReactMarkdown from "react-markdown";
import remarkGfm from "remark-gfm";
//#region src/features/ai/DocumentSelectionContext.tsx
var DocumentSelectionContext = createContext(null);
function DocumentSelectionProvider({ children }) {
	const [selected, setSelected] = useState([]);
	const toggle = useCallback((doc) => {
		setSelected((prev) => {
			if (prev.find((s) => s.id === doc.id)) return prev.filter((s) => s.id !== doc.id);
			return [...prev, {
				id: doc.id,
				title: doc.title,
	...
	const selectAll = useCallback((docs) => {
		setSelected(docs.map((d) => ({
			id: d.id,
			title: d.title,
	...
	const isSelected = useCallback((id) => selected.some((s) => s.id === id), [selected]);
	const ids = selected.map((s) => s.id);
	return /* @__PURE__ */ jsx(DocumentSelectionContext.Provider, {
		value: {
			selected,
			ids,
			toggle,
...
//#endregion
//#region src/features/ai/DocumentSelector.tsx
function DocumentSelector({ docs }) {
	const { selected, toggle, selectAll, clear, isSelected, count } = useSelectedDocuments();
	const [query, setQuery] = useState("");
	const filtered = useMemo(() => query ? docs.filter((d) => d.title.toLowerCase().includes(query.toLowerCase())) : docs, [docs, query]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "relative",
				children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" }), /* @__PURE__ */ jsx(Input, {
					value: query,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Button, {
					...
					children: [allSelected ? /* @__PURE__ */ jsx(CheckSquare, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(Square, { className: "h-3.5 w-3.5" }), allSelected ? "Deselect All" : "Select All"]
				}), count > 0 && /* @__PURE__ */ jsxs(Button, {
					variant: "ghost",
					size: "sm",
					onClick: clear,
					className: "text-xs h-7 px-2 gap-1 text-muted-foreground",
					children: [/* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5" }), "Clear"]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [filtered.map((doc) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						onClick: () => toggle(doc),
						className: cn("w-full flex items-center gap-2.5 rounded-lg px-3 py-2 text-left transition-colors border", active ? "bg-primary/5 border-primary/20" : "bg-card border-border hover:bg-accent"),
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: [/* @__PURE__ */ jsx("span", { className: cn("h-1.5 w-1.5 rounded-full", sel?.hasSummary ? "bg-green-500" : "bg-muted-foreground/40") }), /* @__PURE__ */ jsx("span", {
										className: "text-[10px] text-muted-foreground",
										children: sel?.hasSummary ? "Cached AI Summary" : "Summary will be generated"
									})]
								})]
							}),
							/* @__PURE__ */ jsx("div", {
								className: cn("h-4 w-4 rounded border-2 flex items-center justify-center shrink-0 transition-colors", active ? "bg-primary border-primary" : "border-muted-foreground/30"),
								children: active && /* @__PURE__ */ jsx("svg", {
...
function AISummary({ docs, onGenerate, isGenerating, summary }) {
	const { ids, count } = useSelectedDocuments();
	const [showSelector, setShowSelector] = useState(false);
	if (count === 0) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("h3", {
				...
				children: "No Knowledge Sources"
			}),
			/* @__PURE__ */ jsx("p", {
				className: "text-sm text-muted-foreground max-w-xs mb-5",
				children: "Select one or more documents to generate an AI Summary."
			}),
			/* @__PURE__ */ jsxs(Button, {
				onClick: () => setShowSelector(true),
				variant: "outline",
				className: "gap-2",
				children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), " Choose Documents"]
			}),
			showSelector && /* @__PURE__ */ jsxs("div", {
				className: "w-full max-w-sm mt-6 text-left border rounded-xl p-4 bg-card",
				children: [/* @__PURE__ */ jsx(DocumentSelector, { docs }), /* @__PURE__ */ jsx(Button, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(DocumentSelector, { docs })
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: isGenerating ? /* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("p", {
						className: "text-sm text-muted-foreground",
						children: [
							"Click Generate to create an AI Summary from your ",
							count,
							" selected document",
							count > 1 ? "s" : "",
							"."
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Button, {
					...
					children: isGenerating ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Generating..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), summary ? "Regenerate Summary" : "Generate Summary"] })
				}), summary && /* @__PURE__ */ jsxs(Button, {
					variant: "outline",
					onClick: () => onGenerate({
						documentIds: ids,
						force: true
					...
					className: "gap-2",
					children: [/* @__PURE__ */ jsx(RefreshCw, { className: "h-4 w-4" }), "Force"]
				})]
			})
		]
	});
...
function FlashcardTab({ docs }) {
	const { ids } = useSelectedDocuments();
	const [flashcardCount, setFlashcardCount] = useState(10);
	const generateFlashcards = useGenerateFlashcards();
	return /* @__PURE__ */ jsxs("div", {
		className: "flex-1 overflow-y-auto p-6",
		children: [/* @__PURE__ */ jsx(DocumentSelector, { docs }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Button, {
					...
					children: generateFlashcards.isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), "Generating..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "mr-2 h-4 w-4" }), "Generate Flashcards"] })
				}),
				/* @__PURE__ */ jsx(FlashcardViewer, {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("button", {
						onClick: goNext,
						disabled: currentIdx >= allQuestions.length - 1 && !isRevealed,
						className: "disabled:opacity-30 hover:text-foreground",
						children: /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5" })
					})
				]
			...
			selected && !isRevealed ? /* @__PURE__ */ jsxs(Button, {
				onClick: reveal,
				className: "w-full max-w-lg gap-2",
				children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), "Check Answer"]
		...
		children: [/* @__PURE__ */ jsx(DocumentSelector, { docs }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Button, {
					...
					className: "w-full gap-2",
					children: generateQuiz.isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), "Generating..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Sparkles, { className: "mr-2 h-4 w-4" }), "Generate Quiz"] })
				}),
				/* @__PURE__ */ jsx(QuizViewer, {
...
function AIChat({ folderId, docId }) {
	...
	return /* @__PURE__ */ jsx(DocumentSelectionProvider, { children: /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					activeTab === "content" && /* @__PURE__ */ jsx("div", {
						...
						}) : doc.data?.status === "REJECT" ? /* @__PURE__ */ jsx("div", {
					...
					" ",
					activeTab === "summary" && /* @__PURE__ */ jsx(AISummary, {
						docs,
					...
					activeTab === "flashcards" && /* @__PURE__ */ jsx(FlashcardTab, { docs }),
					activeTab === "quizzes" && /* @__PURE__ */ jsx(QuizTab, { docs })
				]
			}),
			/* @__PURE__ */ jsxs("aside", {
				className: "bg-card border border-border rounded-2xl flex flex-col overflow-hidden shadow-soft",
