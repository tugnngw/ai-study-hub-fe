import { o as quizApi } from "./realApi-BCKVeZFR.js";
import { t as Route } from "./ai-BcZMfPi4.js";
...
import { t as DocumentActionsMenu } from "./document-actions-menu-C9PZ-biU.js";
import { n as CardContent, t as Card } from "./card-CzWHiRuJ.js";
import { n as aiUnavailableReason, r as isAIAvailable, t as DocumentViewer } from "./DocumentViewer-ekfDg3Tg.js";
import { t as Progress } from "./progress-BS38uVhb.js";
import { t as DocumentStatusBadge } from "./document-status-badge-DrdFf6xM.js";
import { useCallback, useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { AlertTriangle, Check, CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, FileText, FolderClosed, FolderX, Infinity as Infinity$1, Info, Loader2, MessageSquare, Plus, RefreshCw, RotateCcw, Send, Shuffle, Sparkles, Trash2, Upload, XCircle } from "lucide-react";
...
function QuizViewer({ quizzes, isLoading }) {
	...
	useEffect(() => {
		const handler = (e) => {
			if (e.key === "ArrowRight" && currentIdx < allQuestions.length - 1) setCurrentIdx((i) => i + 1);
			if (e.key === "ArrowLeft") goPrev();
		};
		window.addEventListener("keydown", handler);
		return () => window.removeEventListener("keydown", handler);
					...
					children: allQuestions.map(({ q }, i) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: (shuffledOptions.get(q.id) ?? [
									{
										label: "A",
										content: q.optionA
									},
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => currentIdx < allQuestions.length - 1 && setCurrentIdx((i) => i + 1),
			...
			!selected && !results.has(q.id) && /* @__PURE__ */ jsx("p", {
				className: "text-xs text-muted-foreground",
				children: "Select an answer above"
			}),
			results.has(q.id) && /* @__PURE__ */ jsx("p", {
				className: "text-xs text-muted-foreground",
				children: currentIdx < allQuestions.length - 1 ? "Đang chuyển sang câu tiếp theo…" : "Hoàn thành!"
			})
		]
	});
}
