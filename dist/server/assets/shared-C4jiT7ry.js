...
var sharesApi = {
  getSharedWithMe: () => api("/api/shares/with-me"),
  getSharedByMe: () => api("/api/shares/by-me"),
  deleteShared: (folderId) =>
    api(`/api/folder/delete/${folderId}`, { method: "DELETE" }),
  getShareLink: (shareId) => api(`/api/shares/${shareId}/link`),
  getDownloadUrl: (shareId) => api(`/api/shares/${shareId}/download`),
};
//#endregion
...
var PALETTE = ["#F4F0FF", "#EAFBF1", "#FFF6E7", "#FDEEF1", "#E7F4FF"];
...
function PersonAvatar({ person, size = 28 }) {
  ...
  return /* @__PURE__ */ jsx("span", {
    className:
      "inline-flex items-center justify-center rounded-full font-semibold text-[11px] text-foreground/70 ring-2 ring-background shrink-0",
    style: {
      width: size,
      height: size,
    ...
    children: [
      /* @__PURE__ */ jsx(DropdownMenuTrigger, {
        ...
        children: /* @__PURE__ */ jsx("button", {
          className:
            "h-8 w-8 rounded-lg flex items-center justify-center text-muted-foreground hover:bg-accent hover:text-foreground transition-colors",
    ...
    children: [
      /* @__PURE__ */ jsxs("h2", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", {
            className:
              "inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full bg-muted text-xs font-semibold text-muted-foreground",
            children: count,
          }),
        ],
      }),
      /* @__PURE__ */ jsx(Card, {
        children: /* @__PURE__ */ jsxs(CardContent, {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", {
              className:
                "grid grid-cols-[28px_1fr_220px_160px_44px] items-center px-4 h-11 bg-muted/40 rounded-t-xl text-xs font-semibold text-muted-foreground",
              children: [
                /* @__PURE__ */ jsx("div", {}),
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("button", {
                          ...
                          className:
                            "h-7 w-7 rounded-md flex items-center justify-center text-muted-foreground hover:bg-accent shrink-0",
      ...
      /* @__PURE__ */ jsx(Card, {
        children: /* @__PURE__ */ jsxs(CardContent, {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", {
              className:
                "grid grid-cols-[1fr_220px_160px_44px] items-center px-4 h-11 bg-muted/40 rounded-t-xl text-xs font-semibold text-muted-foreground",
              children: [
                /* @__PURE__ */ jsx("div", { children: "Tên tài liệu" }),
...
function SharePage() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      showWithMe &&
        /* @__PURE__ */ jsx(SharedWithMeTable, {
          items: s.pagedWithMe,
          count: s.withMeCount,
          page: s.pageWithMe,
