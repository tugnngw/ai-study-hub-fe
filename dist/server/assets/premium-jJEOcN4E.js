...
import { t as useAdminTransactions } from "./useAdminTransactions-B1xjLwx8.js";
...
var PlanFormModal = ({ open, onOpenChange, plan, mode, createPlan, updatePlan }) => {
	...
	const validateForm = () => {
		...
		if (durationDays < -1) return {
			valid: false,
			message: "Thời hạn không được nhỏ hơn 0 ngày (0 là vĩnh viễn)"
		};
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsxs(CardHeader, {
		...
		children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, {
			...
			children: [
				...
				/* @__PURE__ */ jsx(TableCell, { children: p.durationDays === 0 ? "Vĩnh viễn" : p.durationDays ? `${p.durationDays} ngày` : "—" }),
				/* @__PURE__ */ jsx(TableCell, { children: formatStorage(p.storageGb) }),
				/* @__PURE__ */ jsx(TableCell, { children: p.aiQuestions == null ? "—" : p.aiQuestions > 9999 ? "Không giới hạn" : p.aiQuestions }),
