...
import { t as useAdminTransactions } from "./useAdminTransactions-y8dhrrau.js";
...
var PlanFormModal = ({ open, onOpenChange, plan, mode, createPlan, updatePlan }) => {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("p", {
											...
											children: "Số càng cao = gói càng cao. Dùng để ngăn hạ gói khi còn hạn. Gợi ý: Free=0, Basic=1, Pro=2, Premium=3"
										})
									]
								})
							]
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsxs(CardHeader, {
		...
		children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, {
			...
			children: [
				...
				/* @__PURE__ */ jsx(TableHead, { children: "AI Chat" }),
				/* @__PURE__ */ jsx(TableHead, { children: "Quiz" }),
				/* @__PURE__ */ jsx(TableHead, { children: "Flashcard" }),
				/* @__PURE__ */ jsx(TableHead, { children: "Tóm tắt" }),
			...
			children: [
				...
				/* @__PURE__ */ jsx(TableCell, { children: p.chatLimit == null ? "—" : p.chatLimit > 9999 ? "Không giới hạn" : p.chatLimit }),
				/* @__PURE__ */ jsx(TableCell, { children: p.questionLimit == null ? "—" : p.questionLimit > 9999 ? "Không giới hạn" : p.questionLimit }),
				/* @__PURE__ */ jsx(TableCell, { children: p.flashcardLimit == null ? "—" : p.flashcardLimit > 9999 ? "Không giới hạn" : p.flashcardLimit }),
				/* @__PURE__ */ jsx(TableCell, { children: p.summaryLimit == null ? "—" : p.summaryLimit > 9999 ? "Không giới hạn" : p.summaryLimit }),
