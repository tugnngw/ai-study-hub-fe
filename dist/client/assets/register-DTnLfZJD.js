...
import { a as u, i as d, n as f, r as p, t as m } from "./card-Ds71aSGU.js";
...
var _ = e(t()),
  ...
  y = a({
    ...
    password: s().min(6, `Tối thiểu 6 ký tự`),
    confirmPassword: s().min(6, `Tối thiểu 6 ký tự`),
    ...
    children: [
      (0, v.jsxs)(d, {
        children: [
          ...
          (0, v.jsx)(p, {
            children: `Bắt đầu tổ chức tài liệu học tập với AI`,
          }),
        ],
      }),
      (0, v.jsx)(f, {
        children: (0, v.jsxs)(`form`, {
          onSubmit: async (r) => {
            ...
            try {
              (await e({
                ...
                o.success(`Tạo tài khoản thành công! Vui lòng đăng nhập.`),
                t({ to: `/auth/login` }));
            } catch (e) {
              o.error(e instanceof Error ? e.message : `Đăng ký thất bại`);
            } finally {
              S(!1);
            }
          },
          ...
          children: [
            ...
            (0, v.jsx)(l, {
              ...
              disabled: x,
              children: x ? `Đang tạo tài khoản...` : `Tạo tài khoản`,
            }),
            (0, v.jsxs)(`p`, {
