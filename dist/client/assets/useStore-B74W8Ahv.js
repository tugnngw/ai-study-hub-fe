...
function A(e, t, n = new Uint16Array(6)) {
  let r = e.indexOf(`/`, t),
    i = r === -1 ? e.length : r,
    a = e.substring(t, i);
  if (!a || !a.includes(`$`))
...
function j(e, t, n, r, i, a, o) {
      ...
      switch (((s = d + 1), a++, e[0])) {
        ...
        case 1: {
          ...
          if (h) o = h;
            ...
            let e = F(1, n.fullPath ?? n.from, f, p, m);
            ((o = e),
              (e.depth = a),
              (e.parent = i),
              (i.dynamic ??= []),
        ...
        case 3: {
          ...
          if (h) o = h;
            ...
            let e = F(3, n.fullPath ?? n.from, f, p, m);
            ((o = e),
              (e.parent = i),
              (e.depth = a),
              (i.optional ??= []),
  ...
  if (n.children) for (let r of n.children) j(e, t, r, s, i, a, o);
}
function M(e, t) {
...
function oe(e, t) {
  let n = P(`/`),
    r = new Uint16Array(6);
  for (let t of e) j(!1, r, t, 1, n, 0);
  (N(n), (t.masksTree = n), (t.flatCache = E(1e3)));
}
function se(e, t) {
  e ||= `/`;
...
function de(e, t = !1, n) {
  ...
  return (
    j(t, i, e, 1, r, 0, (e) => {
      if ((n?.(e, s), e.id in a && T(), (a[e.id] = e), s !== 0 && e.path)) {
        let t = ue(e.fullPath);
...
function B(e, t, n, r) {
  ...
  for (; c.length; ) {
    ...
    if (i.kind === 2 && i.route && !U(u, n)) continue;
    if (i.parse) {
      if (!H(e, t, n)) continue;
      ((_ = n.rawParams), (g = n.extract));
    }
    r && i.route && i.kind !== D && U(l, n) && (l = n);
    let v = a === s;
    if (
      v &&
      (i.route && (!o || i.kind === D || i.kind === 2) && U(u, n) && (u = n),
    ...
    if (v && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (H(e, t, n) || (r = !1)), r)) {
        if (!m && !h && !d && fe(p, s)) return n;
        U(u, n) && (u = n);
      }
    }
    if (i.wildcard)
          ...
          (t.dynamics > e.dynamics ||
            (t.dynamics === e.dynamics &&
              (t.optionals > e.optionals ||
                (t.optionals === e.optionals &&
                  ((t.node.kind === D) > (e.node.kind === D) ||
                    ((t.node.kind === D) == (e.node.kind === D) &&
                      t.depth > e.depth)))))))
    : !0;
}
function pe(e) {
  return W(e.filter((e) => e !== void 0).join(`/`));
}
function W(e) {
...
function ge({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  let a = t.startsWith(`/`),
    o = !a && t === `.`,
    s;
  if (r) {
  ...
  c.length > 1 &&
    (i(c) === `` ? n === `never` && c.pop() : n === `always` && c.push(``));
  let l = W(c.join(`/`)) || `/`;
...
var X = e(n(), 1),
  Z = r();
function ye({ children: e, fallback: t = null }) {
  return Q()
    ? (0, Z.jsx)(X.Fragment, { children: e })
    : (0, Z.jsx)(X.Fragment, { children: t });
}
function Q() {
...
function Te(e, t, n = we) {
  let r = (0, X.useCallback)(
    ...
    i = (0, X.useCallback)(() => e?.get(), [e]);
  return (0, $.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
export {
  l as A,
  ae as C,
