...
import { t as i } from "./check-BgZ0eYb5.js";
import { t as a } from "./chevron-right-BOXqmgO9.js";
import { t as o } from "./circle-BahSx_IZ.js";
import { a as s, i as c, o as l, t as u } from "./utils-BUTip_f_.js";
import { n as d, t as f } from "./dist-D9ZlzrYt.js";
import { i as p, n as m, r as h, t as g } from "./dist-Cc8O5o4E.js";
import { t as _ } from "./dist-DTO6IMEA.js";
import { n as v, t as y } from "./dist-CeE5QqrL.js";
import { t as b } from "./dist-CSSZD7LS.js";
import {
  a as x,
  i as S,
  n as C,
...
import { a as D, i as O, n as k, r as A, t as j } from "./dist-DTuj8fZP.js";
var M = e(t(), 1),
...
function fe(e, t, n, r) {
  let i = H(e),
    a = de(V(e), n === `start`, r);
  return (
    i && ((a = a.map((e) => e + `-` + i)), t && (a = a.concat(a.map(oe)))),
    a
  );
}
function pe(e) {
...
var ye = 50,
  be = async (e, t, n) => {
    let {
      ...
      s = o.detectOverflow ? o : { ...o, detectOverflow: ve },
        ...
        async fn(t) {
          ...
          if (
            ...
            if (
              ...
              (!(u === `alignment` && _ !== U(t)) ||
                T.every((e) =>
                  U(e.placement) === _ ? e.overflows[0] > 0 : !0,
                ))
            )
              return {
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          let { rects: n, platform: r } = t,
            { strategy: i = `referenceHidden`, ...a } = B(e, t);
          switch (i) {
            case `referenceHidden`: {
              ...
              return {
                data: { referenceHiddenOffsets: e, referenceHidden: we(e) },
              };
            }
            case `escaped`: {
              let e = Ce(
      ...
      e === void 0 && (e = {}),
      {
        ...
        fn(t) {
          let { x: n, y: r, placement: i, rects: a, middlewareData: o } = t,
            { offset: s = 0, mainAxis: c = !0, crossAxis: l = !0 } = B(e, t),
            u = { x: n, y: r },
            d = U(i),
            f = te(d),
            p = u[f],
        ...
        async fn(t) {
          ...
          if (
            ...
            let e = F(u.left, 0),
              ...
              r = F(u.bottom, 0);
            p
              ? (w = m - 2 * (e !== 0 || t !== 0 ? e + t : F(u.left, u.right)))
              : (C = h - 2 * (n !== 0 || r !== 0 ? n + r : F(u.top, u.bottom)));
          }
...
function Pe(e) {
  return Me() ? e instanceof Node || e instanceof W(e).Node : !1;
}
function K(e) {
  return Me() ? e instanceof Element || e instanceof W(e).Element : !1;
}
function q(e) {
  return Me() ? e instanceof HTMLElement || e instanceof W(e).HTMLElement : !1;
}
function Fe(e) {
...
function Ue(e) {
  ...
  return (
    ...
    Ve(t.rotate) ||
    Ve(t.perspective) ||
    (!Ge() && (Ve(t.backdropFilter) || Ve(t.filter))) ||
...
function Ke(e) {
  return /^(html|body|#document)$/.test(Ne(e));
}
function J(e) {
...
function Y(e) {
  ...
  let t = e.assignedSlot || e.parentNode || (Fe(e) && e.host) || G(e);
...
function rt(e, t, n, r) {
  ...
  return ge({ width: u, height: d, x: c, y: l });
}
function it(e, t) {
...
function ot(e) {
  ...
  let c = { scrollLeft: 0, scrollTop: 0 },
    ...
    u = R(0),
    d = q(r);
  if ((d || (!d && !a)) && ((Ne(r) !== `body` || Ie(o)) && (c = qe(r)), d)) {
    let e = rt(r);
    ((l = $e(r)), (u.x = e.x + r.clientLeft), (u.y = e.y + r.clientTop));
  }
  let f = o && !d && !a ? at(o, c) : R(0);
  return {
    width: n.width * l.x,
    height: n.height * l.y,
...
function ct(e) {
  let t = G(e),
    ...
    i = F(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth),
    a = F(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight),
    o = -n.scrollLeft + it(e),
    s = -n.scrollTop;
  return (
    J(r).direction === `rtl` && (o += F(t.clientWidth, r.clientWidth) - i),
...
function pt(e, t) {
  let n = Y(e);
  return n === t || !K(n) || Ke(n) ? !1 : J(n).position === `fixed` || pt(n, t);
}
function mt(e, t) {
  let n = t.get(e);
  if (n) return n;
  let r = Ye(e, [], !1).filter((e) => K(e) && Ne(e) !== `body`),
    i = null,
...
function _t(e, t, n) {
  ...
  if (r || (!r && !a))
    if (((Ne(t) !== `body` || Ie(i)) && (s = qe(t)), r)) {
      let e = rt(t, !0, a, t);
      ((c.x = e.x + t.clientLeft), (c.y = e.y + t.clientTop));
    } else i && l();
  a && !r && i && l();
  let u = i && !r && !a ? at(i, s) : R(0);
  return {
...
function bt(e, t) {
  ...
  if (!q(e)) {
    let t = Y(e);
    for (; t && !Ke(t); ) {
      if (K(t) && !vt(t)) return t;
      t = Y(t);
    }
    return n;
  }
  let r = yt(e, t);
  for (; r && Le(r) && vt(r); ) r = yt(r, t);
  return r && Ke(r) && vt(r) && !Ue(r) ? n : r || We(e) || n;
}
var xt = async function (e) {
  let t = this.getOffsetParent || bt,
...
function Tt(e, t) {
  ...
  function o(s, c) {
    ...
    if ((s || t(), !f || !p)) return;
    let m = L(d),
      h = L(i.clientWidth - (u + f)),
      g = L(i.clientHeight - (d + p)),
      _ = L(u),
      v = {
...
var Dt = Oe,
  ...
  Pt = (e, t, n) => {
    let r = new Map(),
      i = { platform: Ct, ...n },
      a = { ...i.platform, _c: r };
    return be(e, t, { ...i, platform: a });
  },
  Ft = e(r(), 1),
  It = typeof document < `u` ? M.useLayoutEffect : function () {};
function Lt(e, t) {
  if (e === t) return !0;
  ...
  if (e && t && typeof e == `object`) {
    ...
    for (r = n; r-- !== 0; ) {
      let n = i[r];
      if (!(n === `_owner` && e.$$typeof) && !Lt(e[n], t[n])) return !1;
    }
    return !0;
  }
  return e !== e && t !== t;
...
function Vt(e) {
  ...
  let [m, h] = M.useState(null),
    ...
    k = M.useCallback(() => {
      ...
      (D.current && (e.platform = D.current),
        Pt(S.current, C.current, e).then((e) => {
  ...
  let j = M.useMemo(
    ...
    N = M.useMemo(() => ({ reference: b, floating: x }), [b, x]),
    P = M.useMemo(() => {
      let e = { position: n, left: 0, top: 0 };
      if (!N.floating) return e;
      let t = zt(N.floating, u.x),
        r = zt(N.floating, u.y);
      return s
        ? {
            ...e,
  ...
  return M.useMemo(
    () => ({ ...u, update: k, refs: j, elements: N, floatingStyles: P }),
    [u, k, j, N, P],
  );
}
var Ht = (e) => {
    ...
    return {
      ...
      fn(n) {
        ...
        return r && t(r)
          ? r.current == null
            ? {}
            : Mt({ element: r.current, padding: i }).fn(n)
          : r
            ? Mt({ element: r, padding: i }).fn(n)
            : {};
      },
    };
  },
...
var on = `PopperAnchor`,
  sn = M.forwardRef((e, t) => {
    ...
    let d = a.placementState && _n(a.placementState),
      p = d?.[0],
      m = d?.[1];
    return r
      ? null
...
var cn = `PopperContent`,
  ...
  dn = M.forwardRef((e, t) => {
    let {
      ...
      P = N.length > 0,
      F = { padding: j, boundary: N.filter(hn), altBoundary: P },
      {
        refs: I,
        floatingStyles: L,
        placement: R,
        ...
        whileElementsMounted: (...e) =>
          Et(...e, { animationFrame: h === `always` }),
        elements: { reference: x.anchor },
        middleware: [
          Ut({ mainAxis: i + k, alignmentAxis: o }),
          c &&
            Wt({
              mainAxis: !0,
              crossAxis: !1,
              limiter: p === `partial` ? Gt() : void 0,
              ...F,
            }),
          c && Kt({ ...F }),
          qt({
          ...
          T && Yt({ element: T, padding: s }),
          gn({ arrowWidth: O, arrowHeight: k }),
          m &&
            Jt({
    ...
    return (
      ...
      (0, X.jsx)(`div`, {
        ...
        style: {
          ...L,
          transform: ee ? L.transform : `translate(0, -200%)`,
        ...
        children: (0, X.jsx)(ln, {
          ...
          arrowY: U,
          shouldHideArrow: re,
          children: (0, X.jsx)(f.div, {
            "data-side": V,
            "data-align": H,
            ..._,
            ref: w,
            style: { ..._.style, animation: ee ? void 0 : `none` },
          }),
        }),
      })
    );
...
dn.displayName = cn;
var fn = `PopperArrow`,
  pn = { top: `bottom`, right: `left`, bottom: `top`, left: `right` },
...
var vn = an,
  ...
  xn = mn,
  Sn = [`Enter`, ` `],
  Cn = [`ArrowDown`, `PageUp`, `Home`],
  wn = [`ArrowUp`, `PageDown`, `End`],
  Tn = [...Cn, ...wn],
  En = { ltr: [...Sn, `ArrowRight`], rtl: [...Sn, `ArrowLeft`] },
  Dn = { ltr: [`ArrowLeft`], rtl: [`ArrowRight`] },
  On = `Menu`,
  [kn, An, jn] = D(On),
  [Mn, Nn] = _(On, [jn, tn, A]),
  Pn = tn(),
...
var Bn = `MenuAnchor`,
  Vn = M.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e,
      i = Pn(n);
    return (0, X.jsx)(yn, { ...i, ...r, ref: t });
  });
Vn.displayName = Bn;
var Hn = `MenuPortal`,
  [Un, Wn] = Mn(Hn, { forceMount: void 0 }),
  Gn = (e) => {
    ...
    return (0, X.jsx)(Un, {
      ...
      children: (0, X.jsx)(g, {
        present: n || a.open,
        children: (0, X.jsx)(S, { asChild: !0, container: i, children: r }),
      }),
    });
  };
Gn.displayName = Hn;
var Q = `MenuContent`,
  [Kn, qn] = Mn(Q),
  Jn = M.forwardRef((e, t) => {
    let n = Wn(Q, e.__scopeMenu),
      { forceMount: r = n.forceMount, ...i } = e,
      a = Z(Q, e.__scopeMenu),
      o = Rn(Q, e.__scopeMenu);
    return (0, X.jsx)(kn.Provider, {
      scope: e.__scopeMenu,
      children: (0, X.jsx)(g, {
        present: r || a.open,
        children: (0, X.jsx)(kn.Slot, {
          scope: e.__scopeMenu,
          children: o.modal
            ? (0, X.jsx)(Yn, { ...i, ref: t })
            : (0, X.jsx)(Xn, { ...i, ref: t }),
  ...
  Qn = M.forwardRef((e, t) => {
    let {
      ...
      R = M.useRef(0),
      ee = g ? C : M.Fragment,
      z = g ? { as: Zn, allowPinchZoom: !0 } : void 0,
      B = (e) => {
        let t = P.current + e,
          n = E().filter((e) => !e.disabled),
    ...
    (M.useEffect(() => () => window.clearTimeout(N.current), []), T());
    let V = M.useCallback(
      (e) => L.current === I.current?.side && Rr(e, I.current?.area),
      [],
    );
    return (0, X.jsx)(Kn, {
      scope: n,
      ...
      onPointerGraceIntentChange: M.useCallback((e) => {
        I.current = e;
      }, []),
      children: (0, X.jsx)(ee, {
        ...z,
              ...
              children: (0, X.jsx)(bn, {
                ...
                onKeyDown: p(_.onKeyDown, (e) => {
                  ...
                  t &&
                    ...
                    !n && r && B(e.key));
                  let i = A.current;
                  if (e.target !== i || !Tn.includes(e.key)) return;
                  e.preventDefault();
                  let a = E()
                    .filter((e) => !e.disabled)
                    .map((e) => e.ref.current);
                  (wn.includes(e.key) && a.reverse(), Pr(a));
                }),
                onBlur: p(e.onBlur, (e) => {
                ...
                onPointerMove: p(
                  ...
                  zr((e) => {
                    ...
                    e.currentTarget.contains(t) &&
                      n &&
                      ((L.current = e.clientX > R.current ? `right` : `left`),
                      (R.current = e.clientX));
                  }),
                ),
              }),
...
var $n = `MenuGroup`,
  er = M.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, X.jsx)(f.div, { role: `group`, ...r, ref: t });
  });
er.displayName = $n;
var tr = `MenuLabel`,
  nr = M.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, X.jsx)(f.div, { ...r, ref: t });
  });
nr.displayName = tr;
var rr = `MenuItem`,
  ir = `menu.itemSelect`,
  ar = M.forwardRef((e, t) => {
    let { disabled: n = !1, onSelect: r, ...i } = e,
      a = M.useRef(null),
      o = Rn(rr, e.__scopeMenu),
      s = qn(rr, e.__scopeMenu),
      c = l(t, a),
      u = M.useRef(!1),
      f = () => {
        let e = a.current;
        if (!n && e) {
          let t = new CustomEvent(ir, { bubbles: !0, cancelable: !0 });
          (e.addEventListener(ir, (e) => r?.(e), { once: !0 }),
            d(e, t),
            t.defaultPrevented ? (u.current = !1) : o.onClose());
        }
      };
    return (0, X.jsx)(or, {
      ...i,
      ...
      onKeyDown: p(e.onKeyDown, (e) => {
        ...
        n ||
          (t && e.key === ` `) ||
          (Sn.includes(e.key) && (e.currentTarget.click(), e.preventDefault()));
      }),
    });
  });
ar.displayName = rr;
var or = M.forwardRef((e, t) => {
      ...
      (0, X.jsx)(kn.ItemSlot, {
        ...
        children: (0, X.jsx)(j, {
          ...
          children: (0, X.jsx)(f.div, {
            ...
            onPointerLeave: p(
              e.onPointerLeave,
              zr((e) => o.onItemLeave(e)),
            ),
            onFocus: p(e.onFocus, () => m(!0)),
  ...
  cr = M.forwardRef((e, t) => {
    ...
    return (0, X.jsx)(gr, {
      ...
      children: (0, X.jsx)(ar, {
        ...
        "aria-checked": Mr(n) ? `mixed` : n,
        ...i,
        ref: t,
        "data-state": Nr(n),
        onSelect: p(i.onSelect, () => r?.(Mr(n) ? !0 : !n), {
          checkForDefaultPrevented: !1,
        }),
      }),
    });
...
var lr = `MenuRadioGroup`,
  [ur, dr] = Mn(lr, { value: void 0, onValueChange: () => {} }),
  fr = M.forwardRef((e, t) => {
  ...
  mr = M.forwardRef((e, t) => {
    ...
    return (0, X.jsx)(gr, {
      ...
      children: (0, X.jsx)(ar, {
        ...
        ref: t,
        "data-state": Nr(a),
        onSelect: p(r.onSelect, () => i.onValueChange?.(n), {
          checkForDefaultPrevented: !1,
        }),
      }),
    });
...
mr.displayName = pr;
var hr = `MenuItemIndicator`,
  [gr, _r] = Mn(hr, { checked: !1 }),
  vr = M.forwardRef((e, t) => {
    let { __scopeMenu: n, forceMount: r, ...i } = e,
      a = _r(hr, n);
    return (0, X.jsx)(g, {
      present: r || Mr(a.checked) || a.checked === !0,
      children: (0, X.jsx)(f.span, {
        ...i,
        ref: t,
...
vr.displayName = hr;
var yr = `MenuSeparator`,
  br = M.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, X.jsx)(f.div, {
      role: `separator`,
...
var Cr = `MenuSub`,
  ...
  Er = (e) => {
    let { __scopeMenu: t, children: n, open: r = !1, onOpenChange: i } = e,
      ...
      d = y(i);
    return (
      M.useEffect(() => (a.open === !1 && d(!1), () => d(!1)), [a.open, d]),
      (0, X.jsx)(vn, {
        ...o,
        children: (0, X.jsx)(In, {
          scope: t,
...
Er.displayName = Cr;
var Dr = `MenuSubTrigger`,
  Or = M.forwardRef((e, t) => {
    let n = Z(Dr, e.__scopeMenu),
      r = Rn(Dr, e.__scopeMenu),
      i = Tr(Dr, e.__scopeMenu),
      a = qn(Dr, e.__scopeMenu),
      o = M.useRef(null),
...
Or.displayName = Dr;
var kr = `MenuSubContent`,
  Ar = M.forwardRef((e, t) => {
    let n = Wn(Q, e.__scopeMenu),
      { forceMount: r = n.forceMount, align: i = `start`, ...a } = e,
      o = Z(Q, e.__scopeMenu),
      s = Rn(Q, e.__scopeMenu),
      c = Tr(kr, e.__scopeMenu),
      u = M.useRef(null),
      d = l(t, u);
    return (0, X.jsx)(kn.Provider, {
      scope: e.__scopeMenu,
      children: (0, X.jsx)(g, {
        ...
        children: (0, X.jsx)(kn.Slot, {
          ...
          children: (0, X.jsx)(Qn, {
            ...
            trapFocus: !1,
            onOpenAutoFocus: (e) => {
              (s.isUsingKeyboardRef.current && u.current?.focus(),
                e.preventDefault());
            },
...
function Rr(e, t) {
  return t ? Lr({ x: e.clientX, y: e.clientY }, t) : !1;
}
function zr(e) {
...
var Br = zn,
  ...
  oi = (e) => {
    let {
      ...
      c = $(t),
      l = M.useRef(null),
      [u, d] = h({ prop: i, defaultProp: a ?? !1, onChange: o, caller: ti });
    return (0, X.jsx)(ii, {
      scope: t,
      triggerId: m(),
      triggerRef: l,
      ...
      open: u,
      onOpenChange: d,
      onOpenToggle: M.useCallback(() => d((e) => !e), [d]),
      modal: s,
      children: (0, X.jsx)(Br, {
        ...c,
        open: u,
...
ci.displayName = si;
var li = `DropdownMenuPortal`,
  ui = (e) => {
    let { __scopeDropdownMenu: t, ...n } = e,
      r = $(t);
    return (0, X.jsx)(Hr, { ...r, ...n });
  };
ui.displayName = li;
...
var pi = `DropdownMenuGroup`,
  mi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Wr, { ...i, ...r, ref: t });
  });
mi.displayName = pi;
var hi = `DropdownMenuLabel`,
  gi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Gr, { ...i, ...r, ref: t });
  });
gi.displayName = hi;
var _i = `DropdownMenuItem`,
  vi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Kr, { ...i, ...r, ref: t });
  });
vi.displayName = _i;
var yi = `DropdownMenuCheckboxItem`,
  bi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(qr, { ...i, ...r, ref: t });
  });
bi.displayName = yi;
var xi = `DropdownMenuRadioGroup`,
  Si = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Jr, { ...i, ...r, ref: t });
  });
Si.displayName = xi;
var Ci = `DropdownMenuRadioItem`,
  wi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Yr, { ...i, ...r, ref: t });
  });
wi.displayName = Ci;
var Ti = `DropdownMenuItemIndicator`,
  Ei = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Xr, { ...i, ...r, ref: t });
  });
Ei.displayName = Ti;
var Di = `DropdownMenuSeparator`,
  Oi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Zr, { ...i, ...r, ref: t });
  });
Oi.displayName = Di;
var ki = `DropdownMenuArrow`,
  Ai = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(Qr, { ...i, ...r, ref: t });
...
Ai.displayName = ki;
var ji = `DropdownMenuSubTrigger`,
  Mi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)($r, { ...i, ...r, ref: t });
  });
Mi.displayName = ji;
var Ni = `DropdownMenuSubContent`,
  Pi = M.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = $(n);
    return (0, X.jsx)(ei, {
...
var Fi = oi,
  ...
  qi = Fi,
  Ji = Ii,
  Yi = M.forwardRef(({ className: e, inset: t, children: n, ...r }, i) =>
    (0, X.jsxs)(Gi, {
      ref: i,
      className: u(
      ...
      ...r,
      children: [n, (0, X.jsx)(a, { className: `ml-auto` })],
    }),
  );
Yi.displayName = Gi.displayName;
var Xi = M.forwardRef(({ className: e, ...t }, n) =>
  (0, X.jsx)(Ki, {
    ref: n,
    className: u(
...
Xi.displayName = Ki.displayName;
var Zi = M.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) =>
  (0, X.jsx)(Li, {
    children: (0, X.jsx)(Ri, {
      ref: r,
      sideOffset: t,
...
Zi.displayName = Ri.displayName;
var Qi = M.forwardRef(({ className: e, inset: t, ...n }, r) =>
  (0, X.jsx)(Bi, {
    ref: r,
    className: u(
...
Qi.displayName = Bi.displayName;
var $i = M.forwardRef(({ className: e, children: t, checked: n, ...r }, a) =>
  (0, X.jsxs)(Vi, {
    ref: a,
    className: u(
    ...
    children: [
      (0, X.jsx)(`span`, {
        ...
        children: (0, X.jsx)(Ui, {
          children: (0, X.jsx)(i, { className: `h-4 w-4` }),
        }),
      }),
      t,
    ],
...
$i.displayName = Vi.displayName;
var ea = M.forwardRef(({ className: e, children: t, ...n }, r) =>
  (0, X.jsxs)(Hi, {
    ref: r,
    className: u(
      `relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50`,
    ...
    children: [
      (0, X.jsx)(`span`, {
        className: `absolute left-2 flex h-3.5 w-3.5 items-center justify-center`,
        children: (0, X.jsx)(Ui, {
          children: (0, X.jsx)(o, { className: `h-2 w-2 fill-current` }),
        }),
      }),
      t,
    ],
...
ea.displayName = Hi.displayName;
var ta = M.forwardRef(({ className: e, inset: t, ...n }, r) =>
  (0, X.jsx)(zi, {
    ref: r,
    className: u(`px-2 py-1.5 text-sm font-semibold`, t && `pl-8`, e),
    ...n,
  }),
);
ta.displayName = zi.displayName;
var na = M.forwardRef(({ className: e, ...t }, n) =>
  (0, X.jsx)(Wi, { ref: n, className: u(`-mx-1 my-1 h-px bg-muted`, e), ...t }),
);
na.displayName = Wi.displayName;
