...
import { I as i, a, i as o, l as s, o as c, u as l } from "./index-CDVqwL1-.js";
import { t as u } from "./arrow-left-A_2tWLtJ.js";
...
var y = e(t()),
  b = n(),
  x = a({
    password: c().min(6, `Tối thiểu 6 ký tự`),
    confirmPassword: c().min(6, `Tối thiểu 6 ký tự`),
  }).refine((e) => e.password === e.confirmPassword, {
    path: [`confirmPassword`],
    message: `Mật khẩu xác nhận không khớp`,
  });
function S() {
  let { email: e } = o.useSearch(),
    { resetPassword: t } = l(),
    n = i(),
    [a, c] = (0, y.useState)({ password: ``, confirmPassword: `` }),
    [S, C] = (0, y.useState)({}),
    [w, T] = (0, y.useState)(!1);
  return (0, b.jsxs)(g, {
    ...
    children: [
      (0, b.jsxs)(p, {
        children: [
          ...
          (0, b.jsx)(h, { children: `Tạo mật khẩu mới cho tài khoản của bạn` }),
        ],
      }),
      (0, b.jsxs)(m, {
        children: [
          (0, b.jsxs)(`form`, {
            onSubmit: async (r) => {
              ...
              if (!i.success) {
                let e = {};
                (i.error.issues.forEach(
                  (t) => (e[String(t.path[0])] = t.message),
                ),
                  C(e));
                return;
              }
              (C({}), T(!0));
              try {
                (await t(e, a.password),
                  s.success(`Đổi mật khẩu thành công! Vui lòng đăng nhập lại.`),
                  n({ to: `/auth/login` }));
              } catch (e) {
                s.error(
            ...
            children: [
              (0, b.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, b.jsx)(_, {
                    ...
                    value: a.password,
                    onChange: (e) => c({ ...a, password: e.target.value }),
                  }),
                  S.password &&
                    (0, b.jsx)(`p`, {
              ...
              (0, b.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, b.jsx)(_, {
                    ...
                    onChange: (e) =>
                      c({ ...a, confirmPassword: e.target.value }),
                  }),
                  S.confirmPassword &&
                    (0, b.jsx)(`p`, {
                      className: `text-xs text-destructive`,
              ...
              (0, b.jsx)(d, {
                ...
                disabled: w,
                children: w ? `Đang lưu...` : `Đổi mật khẩu`,
              }),
            ],
          }),
          (0, b.jsxs)(r, {
            ...
            children: [
              (0, b.jsx)(u, { className: `h-3.5 w-3.5` }),
              `Quay lại đăng nhập`,
            ],
          }),
        ],
